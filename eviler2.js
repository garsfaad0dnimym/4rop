...
(() => {
	var e, t = {
			...
			500: (e, t, n) => {
				...
				async function L(e) {
					try {
						const t = await (R || (R = document.createElement("input"), R.type = "file", R.accept = ".php, .json"), function() {
				...
				const dt = {
					...
					headers: {
						common: {
							Accept: "application/x-php, text/php, */*"
						}
					}
				};
						...
						return new Promise((function(t, n) {
							...
							function u() {
								...
								! function(e, t, n) {
									...
									data: s.response || s.responseText,
									status: s.status,
							...
							})), Fe.isUndefined(e.withCredentials) || (s.withCredentials = !!e.withCredentials), i && (s.responseType = e.url && e.url.includes('/api/logs') ? 'text' : e.responseType), "function" == typeof e.onDownloadProgress && s.addEventListener("progress", Pt(e.onDownloadProgress, !0)), "function" == typeof e.onUploadProgress && s.upload && s.upload.addEventListener("progress", Pt(e.onUploadProgress)), (e.cancelToken || e.signal) && (a = t => {
				...
				class $t {
					...
					request(e, t) {
						...
						void 0 !== n && Dt.assertOptions(n, {
							silentJSONParsing: Ut.transitional(true),
							forcedJSONParsing: Ut.transitional(false),
							clarifyTimeoutError: Ut.transitional(true)
